...
describe('IonDid', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('createLongFormDid()', () => __awaiter(void 0, void 0, void 0, function* () {
        it('vector test - should create a long-form DID correctly.', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const longFormDid = yield index_1.IonDid.createLongFormDid({ recoveryKey, updateKey, document });
        ...
        it('should not generate invalid JSON when `services` and/or `publicKeys` in given document are `undefined`.', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const initialState = Encoder_1.default.decodeAsString(encodedInitialState, 'just for testing');
        ...
        it('should throw error if given operation key contains unexpected property.', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            JasmineIonErrorValidator_1.default.expectIonErrorToBeThrownAsync(() => __awaiter(void 0, void 0, void 0, function* () { return index_1.IonDid.createLongFormDid({ recoveryKey, updateKey, document: {} }); }), ErrorCode_1.default.PublicKeyJwkEs256kHasUnexpectedProperty);
        }));
        it('should throw error if given operation key contains incorrect crv value.', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            JasmineIonErrorValidator_1.default.expectIonErrorToBeThrownAsync(() => __awaiter(void 0, void 0, void 0, function* () { return index_1.IonDid.createLongFormDid({ recoveryKey, updateKey, document: {} }); }), ErrorCode_1.default.JwkEs256kMissingOrInvalidCrv);
        }));
        it('should throw error if given operation key contains incorrect kty value.', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            JasmineIonErrorValidator_1.default.expectIonErrorToBeThrownAsync(() => __awaiter(void 0, void 0, void 0, function* () { return index_1.IonDid.createLongFormDid({ recoveryKey, updateKey, document: {} }); }), ErrorCode_1.default.JwkEs256kMissingOrInvalidKty);
        }));
        it('should throw error if given operation key contains invalid x length.', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            JasmineIonErrorValidator_1.default.expectIonErrorToBeThrownAsync(() => __awaiter(void 0, void 0, void 0, function* () { return index_1.IonDid.createLongFormDid({ recoveryKey, updateKey, document: {} }); }), ErrorCode_1.default.JwkEs256kHasIncorrectLengthOfX);
        }));
        it('should throw error if given operation key contains invalid y length.', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            JasmineIonErrorValidator_1.default.expectIonErrorToBeThrownAsync(() => __awaiter(void 0, void 0, void 0, function* () { return index_1.IonDid.createLongFormDid({ recoveryKey, updateKey, document: {} }); }), ErrorCode_1.default.JwkEs256kHasIncorrectLengthOfY);
        }));
        it('should throw error if given DID Document JWK is an array.', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            JasmineIonErrorValidator_1.default.expectIonErrorToBeThrownAsync(() => __awaiter(void 0, void 0, void 0, function* () { return index_1.IonDid.createLongFormDid({ recoveryKey, updateKey, document }); }), ErrorCode_1.default.DidDocumentPublicKeyMissingOrIncorrectType);
        }));
        it('should throw error if given DID Document keys with the same ID.', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            JasmineIonErrorValidator_1.default.expectIonErrorToBeThrownAsync(() => __awaiter(void 0, void 0, void 0, function* () { return index_1.IonDid.createLongFormDid({ recoveryKey, updateKey, document }); }), ErrorCode_1.default.DidDocumentPublicKeyIdDuplicated);
        }));
        it('should throw error if given DID Document key ID exceeds maximum length.', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const document = { publicKeys: [anyDidDocumentKey] };
            JasmineIonErrorValidator_1.default.expectIonErrorToBeThrownAsync(() => __awaiter(void 0, void 0, void 0, function* () { return index_1.IonDid.createLongFormDid({ recoveryKey, updateKey, document }); }), ErrorCode_1.default.IdTooLong);
        }));
        ...
        it('should throw error if given service endpoint ID is a duplicate.', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const document = { services };
            JasmineIonErrorValidator_1.default.expectIonErrorToBeThrownAsync(() => __awaiter(void 0, void 0, void 0, function* () { return index_1.IonDid.createLongFormDid({ recoveryKey, updateKey, document }); }), ErrorCode_1.default.DidDocumentServiceIdDuplicated);
        }));
        it('should throw error if given service endpoint ID is not using Base64URL characters', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const document = { services };
            JasmineIonErrorValidator_1.default.expectIonErrorToBeThrownAsync(() => __awaiter(void 0, void 0, void 0, function* () { return index_1.IonDid.createLongFormDid({ recoveryKey, updateKey, document }); }), ErrorCode_1.default.IdNotUsingBase64UrlCharacterSet);
        }));
        it('should throw error if given service endpoint type exceeds maximum length.', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const document = { services };
            JasmineIonErrorValidator_1.default.expectIonErrorToBeThrownAsync(() => __awaiter(void 0, void 0, void 0, function* () { return index_1.IonDid.createLongFormDid({ recoveryKey, updateKey, document }); }), ErrorCode_1.default.ServiceTypeTooLong);
        }));
        it('should throw error if given service endpoint value is an array', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            JasmineIonErrorValidator_1.default.expectIonErrorToBeThrownAsync(() => __awaiter(void 0, void 0, void 0, function* () { return index_1.IonDid.createLongFormDid({ recoveryKey, updateKey, document }); }), ErrorCode_1.default.ServiceEndpointCannotBeAnArray);
        }));
        ...
        it('should throw error if given service endpoint string is not a URL.', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            JasmineIonErrorValidator_1.default.expectIonErrorToBeThrownAsync(() => __awaiter(void 0, void 0, void 0, function* () { return index_1.IonDid.createLongFormDid({ recoveryKey, updateKey, document }); }), ErrorCode_1.default.ServiceEndpointStringNotValidUri);
        }));
        it('should throw error if resulting delta property exceeds maximum size.', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            JasmineIonErrorValidator_1.default.expectIonErrorToBeThrownAsync(() => __awaiter(void 0, void 0, void 0, function* () { return index_1.IonDid.createLongFormDid({ recoveryKey, updateKey, document }); }), ErrorCode_1.default.DeltaExceedsMaximumSize);
        }));
    }));
}));
