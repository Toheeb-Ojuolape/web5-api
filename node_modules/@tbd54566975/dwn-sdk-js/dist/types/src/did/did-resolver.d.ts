...
export declare type DwnServiceEndpoint = {
    nodes: string[];
};
export declare type ServiceEndpoint = {
    id: string;
    type: string;
    serviceEndpoint: string | DwnServiceEndpoint;
    description?: string;
};
export declare type VerificationMethod = {
    id: string;
    type: string;
    controller: string;
    publicKeyJwk?: PublicJwk;
};
export declare type DidResolutionResult = {
    '@context'?: 'https://w3id.org/did-resolution/v1' | string | string[];
    didResolutionMetadata: DidResolutionMetadata;
    didDocument?: DidDocument;
    didDocumentMetadata: DidDocumentMetadata;
};
export declare type DidResolutionMetadata = {
    contentType?: string;
    error?: 'invalidDid' | 'notFound' | 'representationNotSupported' | 'unsupportedDidMethod' | string;
};
export declare type DidDocumentMetadata = {
    created?: string;
    updated?: string;
    deactivated?: boolean;
    versionId?: string;
