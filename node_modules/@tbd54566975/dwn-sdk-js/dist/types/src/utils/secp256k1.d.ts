...
export declare class Secp256k1 {
     ...
     */
    static derivePublicKey(key: Uint8Array, relativePath: string[]): Promise<Uint8Array>;
    /**
     ...
     */
    static deriveChildPublicKey(uncompressedPublicKey: Uint8Array, tweakInput: Uint8Array): Uint8Array;
    /**
     * Derives a child private key using the given tweak input.
     */
    static deriveChildPrivateKey(privateKey: Uint8Array, tweakInput: Uint8Array): Uint8Array;
    /**
