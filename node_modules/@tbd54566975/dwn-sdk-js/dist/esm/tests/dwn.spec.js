...
describe('DWN', () => {
    ...
    describe('create()', () => {
        it('#224 - should be able to initialize a DWN with undefined config', () => __awaiter(void 0, void 0, void 0, function* () {
            const dwnWithoutConfig = yield Dwn.create(); // without passing in a config
            ...
            const reply = yield dwnWithoutConfig.processMessage(tenant, message);
            expect(reply.status.code).to.equal(200);
            expect(reply.entries).to.be.empty;
        }));
    });
    describe('processMessage()', () => {
        it('should process RecordsWrite message signed by a `did:key` DID', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should process RecordsQuery message', () => __awaiter(void 0, void 0, void 0, function* () {
            const alice = yield DidKeyResolver.generate();
            const { author, message } = yield TestDataGenerator.generateRecordsQuery({ author: alice });
            const tenant = author.did;
        ...
        it('should process an EventsGet message', () => __awaiter(void 0, void 0, void 0, function* () {
            const alice = yield DidKeyResolver.generate();
        ...
        it('#191 - regression - should run JSON schema validation', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should throw 400 if given no interface or method found in message', () => __awaiter(void 0, void 0, void 0, function* () {
            const alice = yield DidKeyResolver.generate();
        ...
        it('should throw 401 if message is targeted at a non-tenant', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('handleRecordsRead', () => {
        it('should return error if preprocessing checks fail', () => __awaiter(void 0, void 0, void 0, function* () {
            const alice = yield DidKeyResolver.generate();
            const recordsRead = yield RecordsRead.create({
                recordId: 'recordId-doesnt-matter',
                authorizationSignatureInput: Jws.createSignatureInput(alice)
            });
            recordsRead.message.descriptor.method = 'Write'; // Will cause interface and method check to fail
            const reply = yield dwn.handleRecordsRead(alice.did, recordsRead.message);
            expect(reply.status.code).to.not.equal(200);
        }));
    });
    describe('handleMessagesGet', () => {
        // increases test coverage :)
        it('runs successfully', () => __awaiter(void 0, void 0, void 0, function* () {
            const did = yield DidKeyResolver.generate();
            ...
            const messageCid = yield Message.getCid(recordsWrite.message);
            messageCids.push(messageCid);
            const reply = yield dwn.processMessage(alice.did, recordsWrite.toJSON(), dataStream);
            expect(reply.status.code).to.equal(202);
            const { messagesGet } = yield TestDataGenerator.generateMessagesGet({
                author: alice,
                messageCids
            });
            const messagesGetReply = yield dwn.handleMessagesGet(alice.did, messagesGet.message);
        ...
        it('should return error if preprocessing checks fail', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const messageCids = [yield Message.getCid(recordsWrite.message)];
            const { messagesGet } = yield TestDataGenerator.generateMessagesGet({
                author: alice,
                messageCids
            });
            messagesGet.message.descriptor.interface = 'Protocols'; // Will cause interface and method check to fail
            const reply = yield dwn.handleMessagesGet(alice.did, messagesGet.message);
            expect(reply.status.code).to.not.equal(200);
        }));
    });
    describe('synchronizePrunedInitialRecordsWrite()', () => {
        it('should allow an initial `RecordsWrite` to be written without supplying data', () => __awaiter(void 0, void 0, void 0, function* () {
            var _a, _b;
            const alice = yield DidKeyResolver.generate();
        ...
        it('should run JSON schema validation', () => __awaiter(void 0, void 0, void 0, function* () {
            const invalidMessage = {
                descriptor: {
                    interface: 'Records',
                    method: 'Write'
        ...
        it('should throw 400 if given incorrect DWN interface or method', () => __awaiter(void 0, void 0, void 0, function* () {
            const alice = yield DidKeyResolver.generate();
