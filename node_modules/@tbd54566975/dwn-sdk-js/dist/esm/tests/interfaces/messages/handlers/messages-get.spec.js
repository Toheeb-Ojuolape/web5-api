...
import { DataStoreLevel, DidKeyResolver, DidResolver, Dwn, EventLogLevel, MessageStoreLevel } from '../../../../src/index.js';
...
describe('MessagesGetHandler.handle()', () => {
    ...
    it('returns a 401 if tenant is not author', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('returns a 400 if message is invalid', () => __awaiter(void 0, void 0, void 0, function* () {
        const alice = yield DidKeyResolver.generate();
        const { recordsWrite } = yield TestDataGenerator.generateRecordsWrite({ author: alice });
        const { message } = yield TestDataGenerator.generateMessagesGet({
            author: alice,
    ...
    it('returns a 400 if message contains an invalid message cid', () => __awaiter(void 0, void 0, void 0, function* () {
        const alice = yield DidKeyResolver.generate();
        const { recordsWrite } = yield TestDataGenerator.generateRecordsWrite({ author: alice });
        const { message } = yield TestDataGenerator.generateMessagesGet({
            author: alice,
    ...
    it('returns all requested messages', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const messagesGetReply = yield dwn.processMessage(alice.did, messagesGet.toJSON());
    ...
    it('returns message as undefined in reply entry when a messageCid is not found', () => __awaiter(void 0, void 0, void 0, function* () {
        const alice = yield DidKeyResolver.generate();
        const { recordsWrite } = yield TestDataGenerator.generateRecordsWrite({ author: alice });
    ...
    it('returns an error message for a specific cid if getting that message from the MessageStore fails', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('includes encodedData in reply entry if the data is available and dataSize < threshold', () => __awaiter(void 0, void 0, void 0, function* () {
        const alice = yield DidKeyResolver.generate();
        const { recordsWrite, dataStream } = yield TestDataGenerator.generateRecordsWrite({
            author: alice
        });
    ...
    it('does not return messages that belong to other tenants', () => __awaiter(void 0, void 0, void 0, function* () {
        const alice = yield DidKeyResolver.generate();
        const bob = yield DidKeyResolver.generate();
        const { recordsWrite, dataStream } = yield TestDataGenerator.generateRecordsWrite({
            author: alice
