...
describe('RecordsWriteHandler.handle()', () => {
    ...
    describe('functional tests', () => {
        ...
        it('should only be able to overwrite existing record if new record has a later `dateModified` value', () => __awaiter(void 0, void 0, void 0, function* () {
            var _a, _b, _c;
        ...
        it('should only be able to overwrite existing record if new message CID is larger when `dateModified` value is the same', () => __awaiter(void 0, void 0, void 0, function* () {
            var _d, _e, _f;
        ...
        it('should not allow changes to immutable properties', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should return 400 if actual data size mismatches with `dataSize` in descriptor', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const descriptorCid = yield computeCid(message.descriptor);
        ...
        it('should return 400 if actual data CID of mismatches with `dataCid` in descriptor', () => __awaiter(void 0, void 0, void 0, function* () {
            const alice = yield DidKeyResolver.generate();
        ...
        it('should return 400 if attempting to write a record without data stream', () => __awaiter(void 0, void 0, void 0, function* () {
            const alice = yield DidKeyResolver.generate();
        ...
        it('#359 - should not allow access of data by referencing a different`dataCid` in "modify" `RecordsWrite`', () => __awaiter(void 0, void 0, void 0, function* () {
            const alice = yield DidKeyResolver.generate();
        ...
        describe('initial write & subsequent write tests', () => {
            describe('createFrom()', () => {
                it('should accept a published RecordsWrite using createFrom() without specifying `data` or `datePublished`', () => __awaiter(void 0, void 0, void 0, function* () {
                    var _a;
                    const dataForCid = yield dataStore.blockstore.partition('data');
                ...
                it('should inherit parent published state when using createFrom() to create RecordsWrite', () => __awaiter(void 0, void 0, void 0, function* () {
                    var _b;
                    const { message, author, recordsWrite, dataStream } = yield TestDataGenerator.generateRecordsWrite({
                        published: true
                    });
            ...
            it('should fail with 400 if modifying a record but its initial write cannot be found in DB', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            it('should return 400 if `dateCreated` and `dateModified` are not the same in an initial write', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            it('should return 400 if `contextId` in an initial protocol-base write mismatches with the expected deterministic `contextId`', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            describe('event log', () => {
                it('should add an event to the event log on initial write', () => __awaiter(void 0, void 0, void 0, function* () {
                    const { message, author, dataStream } = yield TestDataGenerator.generateRecordsWrite();
                    TestStubGenerator.stubDidResolver(didResolver, [author]);
                ...
                it('should only keep first write and latest write when subsequent writes happen', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        describe('protocol based writes', () => {
            it('should allow write with allow-anyone rule', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            it('should allow write with recipient rule', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            it('should allow author to write with author rule and block non-authors', () => __awaiter(void 0, void 0, void 0, function* () {
                var _c;
            ...
            it('should allow overwriting records by the same author', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            it('should disallow overwriting existing records by a different author', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            it('should not allow to change immutable recipient', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            it('should block unauthorized write with recipient rule', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            it('should fail authorization if protocol definition cannot be found for a protocol-based RecordsWrite', () => __awaiter(void 0, void 0, void 0, function* () {
                const alice = yield DidKeyResolver.generate();
            ...
            it('should fail authorization if record schema is not an allowed type for protocol-based RecordsWrite', () => __awaiter(void 0, void 0, void 0, function* () {
                const alice = yield DidKeyResolver.generate();
                const protocolDefinition = credentialIssuanceProtocolDefinition;
                const protocol = protocolDefinition.protocol;
            ...
            it('should fail authorization if given `protocolPath` contains an invalid record type', () => __awaiter(void 0, void 0, void 0, function* () {
                const alice = yield DidKeyResolver.generate();
                const protocolDefinition = credentialIssuanceProtocolDefinition;
                const protocol = protocolDefinition.protocol;
                const protocolConfig = yield TestDataGenerator.generateProtocolsConfigure({
            ...
            it('should fail authorization if given `protocolPath` is mismatching with actual path', () => __awaiter(void 0, void 0, void 0, function* () {
                const alice = yield DidKeyResolver.generate();
                const protocolDefinition = credentialIssuanceProtocolDefinition;
                const protocol = protocolDefinition.protocol;
                const protocolConfig = yield TestDataGenerator.generateProtocolsConfigure({
            ...
            it('should fail authorization if given `dataFormat` is mismatching with the dataFormats in protocol definition', () => __awaiter(void 0, void 0, void 0, function* () {
                const alice = yield DidKeyResolver.generate();
                const protocolDefinition = socialMediaProtocolDefinition;
                const protocol = protocolDefinition.protocol;
                const protocolConfig = yield TestDataGenerator.generateProtocolsConfigure({
            ...
            it('should fail authorization if record schema is not allowed at the hierarchical level attempted for the RecordsWrite', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            it('should only allow DWN owner to write if record does not have an action rule defined', () => __awaiter(void 0, void 0, void 0, function* () {
                const alice = yield DidKeyResolver.generate();
            ...
            it('should fail authorization if path to expected recipient in definition has incorrect label', () => __awaiter(void 0, void 0, void 0, function* () {
                const alice = yield DidKeyResolver.generate();
                const issuer = yield DidKeyResolver.generate();
                // create an invalid ancestor path that is longer than possible
                const invalidProtocolDefinition = Object.assign({}, credentialIssuanceProtocolDefinition);
            ...
            it('should look up recipient path with ancestor depth of 2+ (excluding self) in action rule correctly', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            it('should fail authorization if incoming message contains `parentId` that leads to no record', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            it('should 400 if expected CID of `encryption` mismatches the `encryptionCid` in `authorization`', () => __awaiter(void 0, void 0, void 0, function* () {
                const alice = yield TestDataGenerator.generatePersona();
            ...
            it('should return 400 if protocol is not normalized', () => __awaiter(void 0, void 0, void 0, function* () {
                ...
                const descriptorCid = yield computeCid(recordsWrite.message.descriptor);
            ...
            it('#359 - should not allow access of data by referencing `dataCid` in protocol authorized `RecordsWrite`', () => __awaiter(void 0, void 0, void 0, function* () {
                const alice = yield DidKeyResolver.generate();
                const bob = yield DidKeyResolver.generate();
                const dataForCid = yield dataStore.blockstore.partition('data');
        ...
        it('should 400 if dataStream is not provided and dataStore does not contain dataCid', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        describe('reference counting tests', () => {
            it('should only write the data once even if written by multiple messages', () => __awaiter(void 0, void 0, void 0, function* () {
                var _a, _b, _c;
                const alice = yield DidKeyResolver.generate();
                const data = Encoder.stringToBytes('test');
                const dataCid = yield Cid.computeDagPbCidFromBytes(data);
                ...
                const blockstoreOfGivenTenant = yield blockstoreForData.partition(alice.did);
                const blockstoreOfGivenDataCid = yield blockstoreOfGivenTenant.partition(dataCid);
                const aliceWrite1Data = yield TestDataGenerator.generateRecordsWrite({
                    author: alice,
                    data
                });
                const aliceWrite1Reply = yield dwn.processMessage(alice.did, aliceWrite1Data.message, aliceWrite1Data.dataStream);
                expect(aliceWrite1Reply.status.code).to.equal(202);
                const aliceQueryWrite1AfterAliceWrite1Data = yield TestDataGenerator.generateRecordsQuery({
                    author: alice,
                    filter: { recordId: aliceWrite1Data.message.recordId }
                });
                const aliceQueryWrite1AfterAliceWrite1Reply = yield dwn.processMessage(alice.did, aliceQueryWrite1AfterAliceWrite1Data.message);
                expect(aliceQueryWrite1AfterAliceWrite1Reply.status.code).to.equal(200);
                expect((_a = aliceQueryWrite1AfterAliceWrite1Reply.entries) === null || _a === void 0 ? void 0 : _a.length).to.equal(1);
                expect(aliceQueryWrite1AfterAliceWrite1Reply.entries[0].encodedData).to.equal(encodedData);
                yield expect(ArrayUtility.fromAsyncGenerator(blockstoreOfGivenDataCid.db.keys())).to.eventually.eql([dataCid]);
                const aliceWrite2Data = yield TestDataGenerator.generateRecordsWrite({
                    author: alice,
                    data
                });
                const aliceWrite2Reply = yield dwn.processMessage(alice.did, aliceWrite2Data.message, aliceWrite2Data.dataStream);
                expect(aliceWrite2Reply.status.code).to.equal(202);
                const aliceQueryWrite1AfterAliceWrite2Data = yield TestDataGenerator.generateRecordsQuery({
                    author: alice,
                    filter: { recordId: aliceWrite1Data.message.recordId }
                });
                const aliceQueryWrite1AfterAliceWrite2Reply = yield dwn.processMessage(alice.did, aliceQueryWrite1AfterAliceWrite2Data.message);
                expect(aliceQueryWrite1AfterAliceWrite2Reply.status.code).to.equal(200);
                expect((_b = aliceQueryWrite1AfterAliceWrite2Reply.entries) === null || _b === void 0 ? void 0 : _b.length).to.equal(1);
                expect(aliceQueryWrite1AfterAliceWrite2Reply.entries[0].encodedData).to.equal(encodedData);
                const aliceQueryWrite2AfterAliceWrite2Data = yield TestDataGenerator.generateRecordsQuery({
                    author: alice,
                    filter: { recordId: aliceWrite2Data.message.recordId }
                });
                const aliceQueryWrite2AfterAliceWrite2Reply = yield dwn.processMessage(alice.did, aliceQueryWrite2AfterAliceWrite2Data.message);
                expect(aliceQueryWrite2AfterAliceWrite2Reply.status.code).to.equal(200);
                expect((_c = aliceQueryWrite2AfterAliceWrite2Reply.entries) === null || _c === void 0 ? void 0 : _c.length).to.equal(1);
                expect(aliceQueryWrite2AfterAliceWrite2Reply.entries[0].encodedData).to.equal(encodedData);
                yield expect(ArrayUtility.fromAsyncGenerator(blockstoreOfGivenDataCid.db.keys())).to.eventually.eql([dataCid]);
            }));
            it('should duplicate same data if written to different tenants', () => __awaiter(void 0, void 0, void 0, function* () {
                var _d, _e, _f;
                const alice = yield DidKeyResolver.generate();
                const bob = yield DidKeyResolver.generate();
                const data = Encoder.stringToBytes('test');
                ...
                expect((_e = aliceQueryWriteAfterBobWriteReply.entries) === null || _e === void 0 ? void 0 : _e.length).to.equal(1);
                expect(aliceQueryWriteAfterBobWriteReply.entries[0].encodedData).to.equal(encodedData);
                const bobQueryWriteAfterBobWriteData = yield TestDataGenerator.generateRecordsQuery({
                    author: bob,
                    filter: { recordId: bobWriteData.message.recordId }
                });
                const bobQueryWriteAfterBobWriteReply = yield dwn.processMessage(bob.did, bobQueryWriteAfterBobWriteData.message);
                expect(bobQueryWriteAfterBobWriteReply.status.code).to.equal(200);
                expect((_f = bobQueryWriteAfterBobWriteReply.entries) === null || _f === void 0 ? void 0 : _f.length).to.equal(1);
            ...
            it('should not allow referencing data across tenants', () => __awaiter(void 0, void 0, void 0, function* () {
                var _g, _h, _j;
                const alice = yield DidKeyResolver.generate();
                const bob = yield DidKeyResolver.generate();
                const data = Encoder.stringToBytes('test');
                ...
                const aliceQueryWriteAfterAliceWriteReply = yield dwn.processMessage(alice.did, aliceQueryWriteAfterAliceWriteData.message);
                expect(aliceQueryWriteAfterAliceWriteReply.status.code).to.equal(200);
                expect((_g = aliceQueryWriteAfterAliceWriteReply.entries) === null || _g === void 0 ? void 0 : _g.length).to.equal(1);
                expect(aliceQueryWriteAfterAliceWriteReply.entries[0].encodedData).to.equal(encodedData);
                yield expect(ArrayUtility.fromAsyncGenerator(blockstoreOfAliceOfDataCid.db.keys())).to.eventually.eql([dataCid]);
                ...
                expect((_h = aliceQueryWriteAfterBobAssociateReply.entries) === null || _h === void 0 ? void 0 : _h.length).to.equal(1);
                ...
                expect((_j = bobQueryAssociateAfterBobAssociateReply.entries) === null || _j === void 0 ? void 0 : _j.length).to.equal(0);
                // verify that bob's blockstore does not contain alice's data
                yield expect(ArrayUtility.fromAsyncGenerator(blockstoreOfAliceOfDataCid.db.keys())).to.eventually.eql([dataCid]);
                yield expect(ArrayUtility.fromAsyncGenerator(blockstoreOfBobOfDataCid.db.keys())).to.eventually.eql([]);
            }));
        });
    });
    describe('authorization validation tests', () => {
        it('should return 400 if `recordId` in `authorization` payload mismatches with `recordId` in the message', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should return 400 if `contextId` in `authorization` payload mismatches with `contextId` in the message', () => __awaiter(void 0, void 0, void 0, function* () {
            // generate a message with protocol so that computed contextId is also computed and included in message
        ...
        it('should return 401 if `authorization` signature check fails', () => __awaiter(void 0, void 0, void 0, function* () {
            const { author, message, dataStream } = yield TestDataGenerator.generateRecordsWrite();
            const tenant = author.did;
        ...
        it('should return 401 if an unauthorized author is attempting write', () => __awaiter(void 0, void 0, void 0, function* () {
            const author = yield TestDataGenerator.generatePersona();
    ...
    describe('attestation validation tests', () => {
        it('should fail with 400 if `attestation` payload contains properties other than `descriptorCid`', () => __awaiter(void 0, void 0, void 0, function* () {
            const { author, message, recordsWrite, dataStream } = yield TestDataGenerator.generateRecordsWrite();
            const tenant = author.did;
            const signatureInput = Jws.createSignatureInput(author);
            ...
            const authorizationPayload = Object.assign({}, recordsWrite.authorizationPayload);
            authorizationPayload.attestationCid = yield computeCid(attestationPayload);
            const authorizationPayloadBytes = Encoder.objectToBytes(authorizationPayload);
        ...
        it('should fail validation with 400 if more than 1 attester is given ', () => __awaiter(void 0, void 0, void 0, function* () {
            const alice = yield DidKeyResolver.generate();
            const bob = yield DidKeyResolver.generate();
        ...
        it('should fail validation with 400 if the `attestation` does not include the correct `descriptorCid`', () => __awaiter(void 0, void 0, void 0, function* () {
            const alice = yield DidKeyResolver.generate();
        ...
        it('should fail validation with 400 if expected CID of `attestation` mismatches the `attestationCid` in `authorization`', () => __awaiter(void 0, void 0, void 0, function* () {
            const alice = yield DidKeyResolver.generate();
            const { message, dataStream } = yield TestDataGenerator.generateRecordsWrite({ author: alice, attesters: [alice] });
    ...
    it('should throw if `recordsWritehandler.putData()` throws unknown error', () => __awaiter(void 0, void 0, void 0, function* () {
        const { author, message, dataStream } = yield TestDataGenerator.generateRecordsWrite();
        const tenant = author.did;
