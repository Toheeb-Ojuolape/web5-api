...
describe('RecordsWrite', () => {
    describe('create()', () => {
        ...
        it('should throw if attempting to use `protocols` key derivation encryption scheme on non-protocol-based record', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield expect(createPromise).to.be.rejectedWith(DwnErrorCode.RecordsProtocolsDerivationSchemeMissingProtocol);
        }));
        it('should throw if attempting to use `schemas` key derivation encryption scheme on a record without `schema`', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield expect(createPromise).to.be.rejectedWith(DwnErrorCode.RecordsSchemasDerivationSchemeMissingSchema);
        }));
    });
    describe('createFrom()', () => {
    ...
    describe('compareModifiedTime', () => {
        it('should return 0 if age is same', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const a = (yield TestDataGenerator.generateRecordsWrite({ dateModified })).message;
            const b = JSON.parse(JSON.stringify(a)); // create a deep copy of `a`
            const compareResult = yield RecordsWrite.compareModifiedTime(a, b);
    ...
    describe('getNewestMessage', () => {
        it('should return the newest message', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield sleep(1); // need to sleep for at least one millisecond else some messages get generated with the same time
            ...
            const newestMessage = yield RecordsWrite.getNewestMessage([b, c, a]);
