...
describe('RecordsDelete', () => {
    describe('create()', () => {
        it('should use `dateModified` as is if given', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should auto-fill `dateModified` if not given', () => __awaiter(void 0, void 0, void 0, function* () {
            const alice = yield TestDataGenerator.generatePersona();
            const recordsDelete = yield RecordsDelete.create({
                recordId: 'anything',
                authorizationSignatureInput: Jws.createSignatureInput(alice)
