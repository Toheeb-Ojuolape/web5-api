...
describe('ProtocolsConfigure schema definition', () => {
    ...
    describe('rule-set tests', () => {
        ...
        it('#183 - should throw if required `of` is missing in rule-set', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it('#183 - should throw if `of` is present in `anyone` rule-set', () => __awaiter(void 0, void 0, void 0, function* () {
            const invalidRuleSet = {
                $actions: [{
                        who: 'anyone',
                        of: 'thread',
