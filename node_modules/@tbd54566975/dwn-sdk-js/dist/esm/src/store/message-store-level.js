...
export class MessageStoreLevel {
    ...
    get(tenant, cidString, options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const decodedBlock = yield abortOr(options === null || options === void 0 ? void 0 : options.signal, block.decode({ bytes, codec: cbor, hasher: sha256 }));
    ...
    put(tenant, message, indexes, options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            (_a = options === null || options === void 0 ? void 0 : options.signal) === null || _a === void 0 ? void 0 : _a.throwIfAborted();
            const partition = yield abortOr(options === null || options === void 0 ? void 0 : options.signal, this.blockstore.partition(tenant));
            const encodedMessageBlock = yield abortOr(options === null || options === void 0 ? void 0 : options.signal, block.encode({ value: message, codec: cbor, hasher: sha256 }));
