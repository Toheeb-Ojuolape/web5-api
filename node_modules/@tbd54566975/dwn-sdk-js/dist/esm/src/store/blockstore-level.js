...
export class BlockstoreLevel {
    ...
    getAll(options) {
        return __asyncGenerator(this, arguments, function* getAll_1() {
            ...
            try {
                for (var li_1 = __asyncValues(li), li_1_1; li_1_1 = yield __await(li_1.next()), !li_1_1.done;) {
                    const [key, value] = li_1_1.value;
                ...
                try {
                    if (li_1_1 && !li_1_1.done && (_a = li_1.return)) yield __await(_a.call(li_1));
                }
