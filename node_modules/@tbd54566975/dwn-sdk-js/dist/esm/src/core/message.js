...
export class Message {
    ...
    static getCid(message) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const cid = yield computeCid(message);
            return cid;
        });
    }
    /**
     ...
     */
    static isCidLarger(a, b) {
        return __awaiter(this, void 0, void 0, function* () {
            const aIsLarger = ((yield Message.compareCid(a, b)) > 0);
            return aIsLarger;
        });
    }
    /**
    ...
    static getMessageWithLargestCid(messages) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const message of messages) {
                if (currentNewestMessage === undefined || (yield Message.isCidLarger(message, currentNewestMessage))) {
     ...
     */
    static signAsAuthorization(descriptor, signatureInput) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    static isNewer(a, b) {
        return __awaiter(this, void 0, void 0, function* () {
            const aIsNewer = ((yield Message.compareModifiedTime(a, b)) > 0);
            return aIsNewer;
        });
    }
    /**
     ...
     */
    static compareModifiedTime(a, b) {
        return __awaiter(this, void 0, void 0, function* () {
