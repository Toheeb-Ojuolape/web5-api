...
export class RecordsWriteHandler {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (options === undefined || !options.skipDataStorage) {
                    yield this.putData(tenant, message, dataStream, newestExistingMessage);
                }
            }
            catch (error) {
                const e = error;
     ...
     */
    putData(tenant, message, dataStream, newestExistingMessage) {
        return __awaiter(this, void 0, void 0, function* () {
            let result;
            ...
            if (dataStream === undefined) {
                ...
                if ((newestExistingMessage === null || newestExistingMessage === void 0 ? void 0 : newestExistingMessage.descriptor.dataCid) !== message.descriptor.dataCid) {
                    throw new DwnError(DwnErrorCode.RecordsWriteMissingDataStream, 'Data stream is not provided.');
                }
            ...
            if (message.descriptor.dataSize !== result.dataSize) {
                ...
                throw new DwnError(DwnErrorCode.RecordsWriteDataSizeMismatch, `actual data size ${result.dataSize} bytes does not match dataSize in descriptor: ${message.descriptor.dataSize}`);
            }
            ...
            if (message.descriptor.dataCid !== result.dataCid) {
                ...
                yield this.dataStore.delete(tenant, messageCid, message.descriptor.dataCid);
                throw new DwnError(DwnErrorCode.RecordsWriteDataCidMismatch, `actual data CID ${result.dataCid} does not match dataCid in descriptor: ${message.descriptor.dataCid}`);
            }
        });
    }
}
