...
exports.PublicJwk = exports.RecordsRead = exports.ProtocolsQuery = exports.ProtocolsConfigure = exports.ProtocolRuleSet = exports.ProtocolDefinition = exports.PermissionsRequest = exports.PermissionsGrant = exports.PermissionsDefinitions = exports.MessagesGet = exports.JwkVerificationMethod = exports.HooksWrite = exports.GeneralJws = exports.GeneralJwk = exports.Definitions = exports.EventsGet = exports.RecordsWrite = exports.RecordsQuery = exports.RecordsDelete = void 0;
exports.RecordsDelete = validate10;
            ...
            if (((data.authorization === undefined) && (missing0 = "authorization")) || ((data.descriptor === undefined) && (missing0 = "descriptor"))) {
                ...
                if (_errs1 === errors) {
                    if (data.authorization !== undefined) {
                        var _errs2 = errors;
                        if (!(validate11(data.authorization, { instancePath: instancePath + "/authorization", parentData: data, parentDataProperty: "authorization", rootData: rootData }))) {
                    ...
                    if (valid0) {
                        if (data.descriptor !== undefined) {
                            var data1 = data.descriptor;
                            var _errs3 = errors;
                            if (errors === _errs3) {
                                if (data1 && typeof data1 == "object" && !Array.isArray(data1)) {
                                    var missing1 = void 0;
                                    if (((((data1.interface === undefined) && (missing1 = "interface")) || ((data1.method === undefined) && (missing1 = "method"))) || ((data1.dateModified === undefined) && (missing1 = "dateModified"))) || ((data1.recordId === undefined) && (missing1 = "recordId"))) {
                                        ...
                                        if (_errs5 === errors) {
                                            ...
                                            if (valid1) {
                                                ...
                                                if (valid1) {
                                                    if (data1.dateModified !== undefined) {
                                                        var _errs10 = errors;
...
exports.RecordsQuery = validate14;
...
var schema18 = { "type": "string", "pattern": "^\\d{4}-[0-1]\\d-[0-3]\\dT(?:[0-2]\\d:[0-5]\\d:[0-5]\\d|23:59:60)\\.\\d{6}Z$" };
var schema19 = { "type": "string", "pattern": "^did:([a-z0-9]+):((?:(?:[a-zA-Z0-9._-]|(?:%[0-9a-fA-F]{2}))*:)*((?:[a-zA-Z0-9._-]|(?:%[0-9a-fA-F]{2}))+))((;[a-zA-Z0-9_.:%-]+=[a-zA-Z0-9_.:%-]*)*)(/[^#?]*)?([?][^#]*)?(#.*)?$" };
                    ...
                    if (valid0) {
                        if (data.descriptor !== undefined) {
                            ...
                            if (errors === _errs3) {
                                if (data1 && typeof data1 == "object" && !Array.isArray(data1)) {
                                    var missing1 = void 0;
                                    if (((((data1.interface === undefined) && (missing1 = "interface")) || ((data1.method === undefined) && (missing1 = "method"))) || ((data1.dateCreated === undefined) && (missing1 = "dateCreated"))) || ((data1.filter === undefined) && (missing1 = "filter"))) {
                                        ...
                                        if (_errs5 === errors) {
                                            ...
                                            if (valid1) {
                                                ...
                                                if (valid1) {
                                                    if (data1.dateCreated !== undefined) {
                                                        var data4 = data1.dateCreated;
                                                        var _errs10 = errors;
                                                        var _errs11 = errors;
                                                        if (errors === _errs11) {
                                                            if (typeof data4 === "string") {
                                                                if (!pattern3.test(data4)) {
                                                                    validate14.errors = [{ instancePath: instancePath + "/descriptor/dateCreated", schemaPath: "https://identity.foundation/dwn/json-schemas/defs.json#/definitions/date-time/pattern", keyword: "pattern", params: { pattern: "^\\d{4}-[0-1]\\d-[0-3]\\dT(?:[0-2]\\d:[0-5]\\d:[0-5]\\d|23:59:60)\\.\\d{6}Z$" }, message: "must match pattern \"" + "^\\d{4}-[0-1]\\d-[0-3]\\dT(?:[0-2]\\d:[0-5]\\d:[0-5]\\d|23:59:60)\\.\\d{6}Z$" + "\"" }];
                                                                    return false;
                                                                }
                                                            }
                                                            else {
                                                                validate14.errors = [{ instancePath: instancePath + "/descriptor/dateCreated", schemaPath: "https://identity.foundation/dwn/json-schemas/defs.json#/definitions/date-time/type", keyword: "type", params: { type: "string" }, message: "must be string" }];
                                                                return false;
                                                            }
                                                        }
                                                        var valid1 = _errs10 === errors;
                                                                ...
                                                                if (data5 && typeof data5 == "object" && !Array.isArray(data5)) {
                                                                    if (Object.keys(data5).length < 1) {
                                                                        ...
                                                                        if (_errs15 === errors) {
                                                                            ...
                                                                            if (valid3) {
                                                                                if (data5.attester !== undefined) {
                                                                                    var data7 = data5.attester;
                                                                                    var _errs18 = errors;
                                                                                    var _errs19 = errors;
                                                                                    if (errors === _errs19) {
                                                                                            ...
                                                                                            if (valid3) {
                                                                                                ...
                                                                                                if (valid3) {
                                                                                                    ...
                                                                                                    if (valid3) {
                                                                                                        ...
                                                                                                        if (valid3) {
                                                                                                            if (data5.dateCreated !== undefined) {
                                                                                                                var data14 = data5.dateCreated;
                                                                                                                var _errs34 = errors;
                                                                                                                if (errors === _errs34) {
                                                                                                                    if (data14 && typeof data14 == "object" && !Array.isArray(data14)) {
                                                                                                                        if (Object.keys(data14).length < 1) {
                                                                                                                            ...
                                                                                                                            if (_errs36 === errors) {
                                                                                                                                if (data14.from !== undefined) {
                                                                                                                                    var data15 = data14.from;
                                                                                                                                    var _errs37 = errors;
                                                                                                                                    var _errs38 = errors;
                                                                                                                                    if (errors === _errs38) {
                                                                                                                                        if (typeof data15 === "string") {
                                                                                                                                            if (!pattern3.test(data15)) {
                                                                                                                                                validate14.errors = [{ instancePath: instancePath + "/descriptor/filter/dateCreated/from", schemaPath: "https://identity.foundation/dwn/json-schemas/defs.json#/definitions/date-time/pattern", keyword: "pattern", params: { pattern: "^\\d{4}-[0-1]\\d-[0-3]\\dT(?:[0-2]\\d:[0-5]\\d:[0-5]\\d|23:59:60)\\.\\d{6}Z$" }, message: "must match pattern \"" + "^\\d{4}-[0-1]\\d-[0-3]\\dT(?:[0-2]\\d:[0-5]\\d:[0-5]\\d|23:59:60)\\.\\d{6}Z$" + "\"" }];
                                                                                                                                                return false;
                                                                                                                                            }
                                                                                                                                        }
                                                                                                                                        else {
                                                                                                                                            validate14.errors = [{ instancePath: instancePath + "/descriptor/filter/dateCreated/from", schemaPath: "https://identity.foundation/dwn/json-schemas/defs.json#/definitions/date-time/type", keyword: "type", params: { type: "string" }, message: "must be string" }];
                                                                                                                                            return false;
                                                                                                                                        }
                                                                                                                                    }
                                                                                                                                ...
                                                                                                                                if (valid6) {
                                                                                                                                    if (data14.to !== undefined) {
                                                                                                                                        var data16 = data14.to;
                                                                                                                                        var _errs40 = errors;
                                                                                                                                        var _errs41 = errors;
                                                                                                                                        if (errors === _errs41) {
                                                                                                                                            if (typeof data16 === "string") {
                                                                                                                                                if (!pattern3.test(data16)) {
                                                                                                                                                    validate14.errors = [{ instancePath: instancePath + "/descriptor/filter/dateCreated/to", schemaPath: "https://identity.foundation/dwn/json-schemas/defs.json#/definitions/date-time/pattern", keyword: "pattern", params: { pattern: "^\\d{4}-[0-1]\\d-[0-3]\\dT(?:[0-2]\\d:[0-5]\\d:[0-5]\\d|23:59:60)\\.\\d{6}Z$" }, message: "must match pattern \"" + "^\\d{4}-[0-1]\\d-[0-3]\\dT(?:[0-2]\\d:[0-5]\\d:[0-5]\\d|23:59:60)\\.\\d{6}Z$" + "\"" }];
                                                                                                                                                    return false;
                                                                                                                                                }
                                                                                                                                            }
                                                                                                                                            else {
                                                                                                                                                validate14.errors = [{ instancePath: instancePath + "/descriptor/filter/dateCreated/to", schemaPath: "https://identity.foundation/dwn/json-schemas/defs.json#/definitions/date-time/type", keyword: "type", params: { type: "string" }, message: "must be string" }];
                                                                                                                                                return false;
                                                                                                                                            }
                                                                                                                                        }
...
exports.RecordsWrite = validate16;
var schema23 = { "$schema": "http://json-schema.org/draft-07/schema#", "$id": "https://identity.foundation/dwn/json-schemas/records-write.json", "type": "object", "additionalProperties": false, "required": ["authorization", "descriptor", "recordId"], "properties": { "recordId": { "type": "string" }, "contextId": { "type": "string" }, "attestation": { "$ref": "https://identity.foundation/dwn/json-schemas/general-jws.json" }, "authorization": { "$ref": "https://identity.foundation/dwn/json-schemas/general-jws.json" }, "encryption": { "type": "object", "properties": { "algorithm": { "type": "string", "enum": ["A256CTR"] }, "initializationVector": { "$ref": "https://identity.foundation/dwn/json-schemas/defs.json#/definitions/base64url" }, "keyEncryption": { "type": "array", "minItems": 1, "items": { "type": "object", "properties": { "rootKeyId": { "type": "string" }, "derivationScheme": { "type": "string", "enum": ["dataFormats", "protocols", "schemas"] }, "algorithm": { "type": "string", "enum": ["ECIES-ES256K"] }, "encryptedKey": { "$ref": "https://identity.foundation/dwn/json-schemas/defs.json#/definitions/base64url" }, "initializationVector": { "$ref": "https://identity.foundation/dwn/json-schemas/defs.json#/definitions/base64url" }, "ephemeralPublicKey": { "$ref": "https://identity.foundation/dwn/json-schemas/public-jwk.json" }, "messageAuthenticationCode": { "$ref": "https://identity.foundation/dwn/json-schemas/defs.json#/definitions/base64url" } }, "additionalProperties": false, "required": ["rootKeyId", "derivationScheme", "algorithm", "encryptedKey", "initializationVector", "ephemeralPublicKey", "messageAuthenticationCode"] } } }, "additionalProperties": false, "required": ["algorithm", "initializationVector", "keyEncryption"] }, "descriptor": { "type": "object", "properties": { "interface": { "enum": ["Records"], "type": "string" }, "method": { "enum": ["Write"], "type": "string" }, "recipient": { "$ref": "https://identity.foundation/dwn/json-schemas/defs.json#/definitions/did" }, "protocol": { "type": "string" }, "protocolPath": { "type": "string", "pattern": "^[a-zA-Z]+(/[a-zA-Z]+)*$" }, "schema": { "type": "string" }, "parentId": { "type": "string" }, "dataCid": { "type": "string" }, "dataSize": { "type": "number" }, "dateCreated": { "$ref": "https://identity.foundation/dwn/json-schemas/defs.json#/definitions/date-time" }, "dateModified": { "$ref": "https://identity.foundation/dwn/json-schemas/defs.json#/definitions/date-time" }, "published": { "type": "boolean" }, "datePublished": { "$ref": "https://identity.foundation/dwn/json-schemas/defs.json#/definitions/date-time" }, "dataFormat": { "type": "string" } }, "additionalProperties": false, "required": ["interface", "method", "dataCid", "dataSize", "dateCreated", "dateModified", "dataFormat"], "dependencies": { "recipient": ["protocol"] }, "allOf": [{ "$comment": "rule defining `published` and `datePublished` relationship", "anyOf": [{ "properties": { "published": { "type": "boolean", "enum": [true] } }, "required": ["published", "datePublished"] }, { "properties": { "published": { "type": "boolean", "enum": [false] } }, "not": { "required": ["datePublished"] } }, { "allOf": [{ "not": { "required": ["published"] } }, { "not": { "required": ["datePublished"] } }] }] }] } }, "$comment": "rule defining `protocol` and `contextId` relationship", "anyOf": [{ "properties": { "descriptor": { "type": "object", "required": ["protocol", "protocolPath", "schema"] } }, "required": ["contextId"] }, { "allOf": [{ "not": { "required": ["contextId"] } }, { "properties": { "descriptor": { "type": "object", "not": { "required": ["protocol"] } } } }, { "properties": { "descriptor": { "type": "object", "not": { "required": ["protocolPath"] } } } }] }] };
var schema27 = { "$id": "https://identity.foundation/dwn/json-schemas/public-jwk.json", "$schema": "http://json-schema.org/draft-07/schema#", "$ref": "https://identity.foundation/dwn/json-schemas/general-jwk.json", "not": { "anyOf": [{ "type": "object", "properties": { "kty": { "const": "EC" } }, "anyOf": [{ "required": ["d"] }] }, { "type": "object", "properties": { "kty": { "const": "OKP" } }, "anyOf": [{ "required": ["d"] }] }, { "type": "object", "properties": { "kty": { "const": "RSA" }, "d": {}, "p": {}, "q": {}, "dp": {}, "dq": {}, "qi": {}, "oth": { "type": "object" } }, "anyOf": [{ "required": ["d"] }, { "required": ["p"] }, { "required": ["q"] }, { "required": ["dp"] }, { "required": ["dq"] }, { "required": ["qi"] }, { "required": ["oth"] }] }] } };
var schema28 = { "$id": "https://identity.foundation/dwn/json-schemas/general-jwk.json", "$schema": "http://json-schema.org/draft-07/schema#", "type": "object", "required": ["kty"], "properties": { "alg": { "type": "string" }, "kid": { "type": "string" }, "kty": { "enum": ["EC", "RSA", "oct", "OKP"] }, "crv": { "type": "string" }, "use": { "type": "string" }, "key_ops": { "type": "string" }, "x5u": { "type": "string" }, "x5c": { "type": "string" }, "x5t": { "type": "string" }, "x5t#S256": { "type": "string" } }, "oneOf": [{ "properties": { "kty": { "const": "EC" }, "crv": { "type": "string" }, "x": { "type": "string" }, "y": { "type": "string" }, "d": { "type": "string" } }, "required": ["crv", "x"] }, { "properties": { "kty": { "const": "OKP" }, "crv": { "type": "string" }, "x": { "type": "string" }, "d": { "type": "string" } }, "required": ["crv", "x"] }, { "properties": { "kty": { "const": "RSA" }, "n": { "type": "string" }, "e": { "type": "string" }, "d": { "type": "string" }, "p": { "type": "string" }, "q": { "type": "string" }, "dp": { "type": "string" }, "dq": { "type": "string" }, "qi": { "type": "string" }, "oth": { "type": "object" } }, "required": ["n", "e"] }, { "properties": { "kty": { "const": "oct" }, "k": { "type": "string" } }, "required": ["k"] }] };
function validate19(data, _a) {
    var _b = _a === void 0 ? {} : _a, _c = _b.instancePath, instancePath = _c === void 0 ? "" : _c, parentData = _b.parentData, parentDataProperty = _b.parentDataProperty, _d = _b.rootData, rootData = _d === void 0 ? data : _d;
    ;
    var vErrors = null;
    var errors = 0;
    ...
    if (data && typeof data == "object" && !Array.isArray(data)) {
        ...
        if (((data.crv === undefined) && (missing0 = "crv")) || ((data.x === undefined) && (missing0 = "x"))) {
            var err0 = { instancePath: instancePath, schemaPath: "https://identity.foundation/dwn/json-schemas/general-jwk.json/oneOf/0/required", keyword: "required", params: { missingProperty: missing0 }, message: "must have required property '" + missing0 + "'" };
            if (vErrors === null) {
                vErrors = [err0];
            }
            else {
            ...
            if (data.kty !== undefined) {
                var _errs4 = errors;
                if ("EC" !== data.kty) {
                    var err1 = { instancePath: instancePath + "/kty", schemaPath: "https://identity.foundation/dwn/json-schemas/general-jwk.json/oneOf/0/properties/kty/const", keyword: "const", params: { allowedValue: "EC" }, message: "must be equal to constant" };
                    if (vErrors === null) {
                        vErrors = [err1];
                    }
                    else {
            ...
            if (valid2) {
                if (data.crv !== undefined) {
                    ...
                    if (typeof data.crv !== "string") {
                        var err2 = { instancePath: instancePath + "/crv", schemaPath: "https://identity.foundation/dwn/json-schemas/general-jwk.json/oneOf/0/properties/crv/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                        if (vErrors === null) {
                            vErrors = [err2];
                        }
                        else {
                ...
                if (valid2) {
                    if (data.x !== undefined) {
                        ...
                        if (typeof data.x !== "string") {
                            var err3 = { instancePath: instancePath + "/x", schemaPath: "https://identity.foundation/dwn/json-schemas/general-jwk.json/oneOf/0/properties/x/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                            if (vErrors === null) {
                                vErrors = [err3];
                            }
                            else {
                    ...
                    if (valid2) {
                        if (data.y !== undefined) {
                            ...
                            if (typeof data.y !== "string") {
                                var err4 = { instancePath: instancePath + "/y", schemaPath: "https://identity.foundation/dwn/json-schemas/general-jwk.json/oneOf/0/properties/y/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                                if (vErrors === null) {
                                    vErrors = [err4];
                                }
                                else {
                        ...
                        if (valid2) {
                            if (data.d !== undefined) {
                                ...
                                if (typeof data.d !== "string") {
                                    var err5 = { instancePath: instancePath + "/d", schemaPath: "https://identity.foundation/dwn/json-schemas/general-jwk.json/oneOf/0/properties/d/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                                    if (vErrors === null) {
                                        vErrors = [err5];
                                    }
                                    else {
    ...
    if (data && typeof data == "object" && !Array.isArray(data)) {
        ...
        if (((data.crv === undefined) && (missing1 = "crv")) || ((data.x === undefined) && (missing1 = "x"))) {
            var err6 = { instancePath: instancePath, schemaPath: "https://identity.foundation/dwn/json-schemas/general-jwk.json/oneOf/1/required", keyword: "required", params: { missingProperty: missing1 }, message: "must have required property '" + missing1 + "'" };
            if (vErrors === null) {
                vErrors = [err6];
            }
            else {
            ...
            if (data.kty !== undefined) {
                var _errs14 = errors;
                if ("OKP" !== data.kty) {
                    var err7 = { instancePath: instancePath + "/kty", schemaPath: "https://identity.foundation/dwn/json-schemas/general-jwk.json/oneOf/1/properties/kty/const", keyword: "const", params: { allowedValue: "OKP" }, message: "must be equal to constant" };
                    if (vErrors === null) {
                        vErrors = [err7];
                    }
                    else {
            ...
            if (valid3) {
                if (data.crv !== undefined) {
                    var _errs15 = errors;
                    if (typeof data.crv !== "string") {
                        var err8 = { instancePath: instancePath + "/crv", schemaPath: "https://identity.foundation/dwn/json-schemas/general-jwk.json/oneOf/1/properties/crv/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                        if (vErrors === null) {
                            vErrors = [err8];
                        }
                        else {
                ...
                if (valid3) {
                    if (data.x !== undefined) {
                        var _errs17 = errors;
                        if (typeof data.x !== "string") {
                            var err9 = { instancePath: instancePath + "/x", schemaPath: "https://identity.foundation/dwn/json-schemas/general-jwk.json/oneOf/1/properties/x/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                            if (vErrors === null) {
                                vErrors = [err9];
                            }
                            else {
                    ...
                    if (valid3) {
                        if (data.d !== undefined) {
                            var _errs19 = errors;
                            if (typeof data.d !== "string") {
                                var err10 = { instancePath: instancePath + "/d", schemaPath: "https://identity.foundation/dwn/json-schemas/general-jwk.json/oneOf/1/properties/d/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                                if (vErrors === null) {
                                    vErrors = [err10];
                                }
                                else {
    ...
    if (_valid0 && valid1) {
        ...
        if (data && typeof data == "object" && !Array.isArray(data)) {
            ...
            if (((data.n === undefined) && (missing2 = "n")) || ((data.e === undefined) && (missing2 = "e"))) {
                var err11 = { instancePath: instancePath, schemaPath: "https://identity.foundation/dwn/json-schemas/general-jwk.json/oneOf/2/required", keyword: "required", params: { missingProperty: missing2 }, message: "must have required property '" + missing2 + "'" };
                if (vErrors === null) {
                    vErrors = [err11];
                }
                else {
                ...
                if (data.kty !== undefined) {
                    var _errs22 = errors;
                    if ("RSA" !== data.kty) {
                        var err12 = { instancePath: instancePath + "/kty", schemaPath: "https://identity.foundation/dwn/json-schemas/general-jwk.json/oneOf/2/properties/kty/const", keyword: "const", params: { allowedValue: "RSA" }, message: "must be equal to constant" };
                        if (vErrors === null) {
                            vErrors = [err12];
                        }
                        else {
                ...
                if (valid4) {
                    if (data.n !== undefined) {
                        ...
                        if (typeof data.n !== "string") {
                            var err13 = { instancePath: instancePath + "/n", schemaPath: "https://identity.foundation/dwn/json-schemas/general-jwk.json/oneOf/2/properties/n/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                            if (vErrors === null) {
                                vErrors = [err13];
                            }
                            else {
                    ...
                    if (valid4) {
                        if (data.e !== undefined) {
                            ...
                            if (typeof data.e !== "string") {
                                var err14 = { instancePath: instancePath + "/e", schemaPath: "https://identity.foundation/dwn/json-schemas/general-jwk.json/oneOf/2/properties/e/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                                if (vErrors === null) {
                                    vErrors = [err14];
                                }
                                else {
                        ...
                        if (valid4) {
                            if (data.d !== undefined) {
                                var _errs27 = errors;
                                if (typeof data.d !== "string") {
                                    var err15 = { instancePath: instancePath + "/d", schemaPath: "https://identity.foundation/dwn/json-schemas/general-jwk.json/oneOf/2/properties/d/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                                    if (vErrors === null) {
                                        vErrors = [err15];
                                    }
                                    else {
                            ...
                            if (valid4) {
                                if (data.p !== undefined) {
                                    ...
                                    if (typeof data.p !== "string") {
                                        var err16 = { instancePath: instancePath + "/p", schemaPath: "https://identity.foundation/dwn/json-schemas/general-jwk.json/oneOf/2/properties/p/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                                        if (vErrors === null) {
                                            vErrors = [err16];
                                        }
                                        else {
                                ...
                                if (valid4) {
                                    if (data.q !== undefined) {
                                        ...
                                        if (typeof data.q !== "string") {
                                            var err17 = { instancePath: instancePath + "/q", schemaPath: "https://identity.foundation/dwn/json-schemas/general-jwk.json/oneOf/2/properties/q/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                                            if (vErrors === null) {
                                                vErrors = [err17];
                                            }
                                            else {
                                    ...
                                    if (valid4) {
                                        if (data.dp !== undefined) {
                                            ...
                                            if (typeof data.dp !== "string") {
                                                var err18 = { instancePath: instancePath + "/dp", schemaPath: "https://identity.foundation/dwn/json-schemas/general-jwk.json/oneOf/2/properties/dp/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                                                if (vErrors === null) {
                                                    vErrors = [err18];
                                                }
                                                else {
                                        ...
                                        if (valid4) {
                                            if (data.dq !== undefined) {
                                                ...
                                                if (typeof data.dq !== "string") {
                                                    var err19 = { instancePath: instancePath + "/dq", schemaPath: "https://identity.foundation/dwn/json-schemas/general-jwk.json/oneOf/2/properties/dq/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                                                    if (vErrors === null) {
                                                        vErrors = [err19];
                                                    }
                                                    else {
                                            ...
                                            if (valid4) {
                                                if (data.qi !== undefined) {
                                                    ...
                                                    if (typeof data.qi !== "string") {
                                                        var err20 = { instancePath: instancePath + "/qi", schemaPath: "https://identity.foundation/dwn/json-schemas/general-jwk.json/oneOf/2/properties/qi/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                                                        if (vErrors === null) {
                                                            vErrors = [err20];
                                                        }
                                                        else {
                                                ...
                                                if (valid4) {
                                                    if (data.oth !== undefined) {
                                                        ...
                                                        if (!(data18 && typeof data18 == "object" && !Array.isArray(data18))) {
                                                            var err21 = { instancePath: instancePath + "/oth", schemaPath: "https://identity.foundation/dwn/json-schemas/general-jwk.json/oneOf/2/properties/oth/type", keyword: "type", params: { type: "object" }, message: "must be object" };
                                                            if (vErrors === null) {
                                                                vErrors = [err21];
                                                            }
                                                            else {
        ...
        if (_valid0 && valid1) {
            ...
            if (data && typeof data == "object" && !Array.isArray(data)) {
                ...
                if ((data.k === undefined) && (missing3 = "k")) {
                    var err22 = { instancePath: instancePath, schemaPath: "https://identity.foundation/dwn/json-schemas/general-jwk.json/oneOf/3/required", keyword: "required", params: { missingProperty: missing3 }, message: "must have required property '" + missing3 + "'" };
                    if (vErrors === null) {
                        vErrors = [err22];
                    }
                    else {
                    ...
                    if (data.kty !== undefined) {
                        var _errs42 = errors;
                        if ("oct" !== data.kty) {
                            var err23 = { instancePath: instancePath + "/kty", schemaPath: "https://identity.foundation/dwn/json-schemas/general-jwk.json/oneOf/3/properties/kty/const", keyword: "const", params: { allowedValue: "oct" }, message: "must be equal to constant" };
                            if (vErrors === null) {
                                vErrors = [err23];
                            }
                            else {
                    ...
                    if (valid5) {
                        if (data.k !== undefined) {
                            ...
                            if (typeof data.k !== "string") {
                                var err24 = { instancePath: instancePath + "/k", schemaPath: "https://identity.foundation/dwn/json-schemas/general-jwk.json/oneOf/3/properties/k/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                                if (vErrors === null) {
                                    vErrors = [err24];
                                }
                                else {
    ...
    if (!valid1) {
        var err25 = { instancePath: instancePath, schemaPath: "https://identity.foundation/dwn/json-schemas/general-jwk.json/oneOf", keyword: "oneOf", params: { passingSchemas: passing0 }, message: "must match exactly one schema in oneOf" };
        if (vErrors === null) {
            vErrors = [err25];
        }
        else {
    ...
    if (errors === _errs0) {
        if (data && typeof data == "object" && !Array.isArray(data)) {
            ...
            if ((data.kty === undefined) && (missing4 = "kty")) {
                validate19.errors = [{ instancePath: instancePath, schemaPath: "https://identity.foundation/dwn/json-schemas/general-jwk.json/required", keyword: "required", params: { missingProperty: missing4 }, message: "must have required property '" + missing4 + "'" }];
                return false;
            }
            else {
                    ...
                    if (valid6) {
                        if (data.kty !== undefined) {
                            ...
                            if (!((((data23 === "EC") || (data23 === "RSA")) || (data23 === "oct")) || (data23 === "OKP"))) {
                                validate19.errors = [{ instancePath: instancePath + "/kty", schemaPath: "https://identity.foundation/dwn/json-schemas/general-jwk.json/properties/kty/enum", keyword: "enum", params: { allowedValues: schema28.properties.kty.enum }, message: "must be equal to one of the allowed values" }];
                                return false;
                            }
            ...
            validate19.errors = [{ instancePath: instancePath, schemaPath: "https://identity.foundation/dwn/json-schemas/general-jwk.json/type", keyword: "type", params: { type: "object" }, message: "must be object" }];
            return false;
        }
    }
    ...
    if (valid0) {
        ...
        if (valid7) {
            validate19.errors = [{ instancePath: instancePath, schemaPath: "#/not", keyword: "not", params: {}, message: "must NOT be valid" }];
            return false;
        }
        else {
            errors = _errs64;
...
function validate16(data, _a) {
    ...
    if (data && typeof data == "object" && !Array.isArray(data)) {
        ...
        if ((data.contextId === undefined) && (missing0 = "contextId")) {
            var err0 = { instancePath: instancePath, schemaPath: "#/anyOf/0/required", keyword: "required", params: { missingProperty: missing0 }, message: "must have required property '" + missing0 + "'" };
            if (vErrors === null) {
                vErrors = [err0];
            }
            else {
                ...
                if (errors === _errs4) {
                    if (data0 && typeof data0 == "object" && !Array.isArray(data0)) {
                        ...
                        if ((((data0.protocol === undefined) && (missing1 = "protocol")) || ((data0.protocolPath === undefined) && (missing1 = "protocolPath"))) || ((data0.schema === undefined) && (missing1 = "schema"))) {
                            var err1 = { instancePath: instancePath + "/descriptor", schemaPath: "#/anyOf/0/properties/descriptor/required", keyword: "required", params: { missingProperty: missing1 }, message: "must have required property '" + missing1 + "'" };
                            if (vErrors === null) {
                                vErrors = [err1];
                            }
                            else {
                        ...
                        var err2 = { instancePath: instancePath + "/descriptor", schemaPath: "#/anyOf/0/properties/descriptor/type", keyword: "type", params: { type: "object" }, message: "must be object" };
                        if (vErrors === null) {
                            vErrors = [err2];
                        }
                        else {
    ...
    if (!valid0) {
        ...
        var valid3 = _errs9 === errors;
        if (valid3) {
            var err4 = { instancePath: instancePath, schemaPath: "#/anyOf/1/allOf/0/not", keyword: "not", params: {}, message: "must NOT be valid" };
            if (vErrors === null) {
                vErrors = [err4];
            }
            else {
        ...
        if (valid2) {
            ...
            if (data && typeof data == "object" && !Array.isArray(data)) {
                if (data.descriptor !== undefined) {
                    var data1 = data.descriptor;
                    if (!(data1 && typeof data1 == "object" && !Array.isArray(data1))) {
                        var err5 = { instancePath: instancePath + "/descriptor", schemaPath: "#/anyOf/1/allOf/1/properties/descriptor/type", keyword: "type", params: { type: "object" }, message: "must be object" };
                        if (vErrors === null) {
                            vErrors = [err5];
                        }
                        else {
                    ...
                    if (valid5) {
                        var err7 = { instancePath: instancePath + "/descriptor", schemaPath: "#/anyOf/1/allOf/1/properties/descriptor/not", keyword: "not", params: {}, message: "must NOT be valid" };
                        if (vErrors === null) {
                            vErrors = [err7];
                        }
                        else {
            ...
            if (valid2) {
                ...
                if (data && typeof data == "object" && !Array.isArray(data)) {
                    if (data.descriptor !== undefined) {
                        var data2 = data.descriptor;
                        if (!(data2 && typeof data2 == "object" && !Array.isArray(data2))) {
                            var err8 = { instancePath: instancePath + "/descriptor", schemaPath: "#/anyOf/1/allOf/2/properties/descriptor/type", keyword: "type", params: { type: "object" }, message: "must be object" };
                            if (vErrors === null) {
                                vErrors = [err8];
                            }
                            else {
                        ...
                        if (valid7) {
                            var err10 = { instancePath: instancePath + "/descriptor", schemaPath: "#/anyOf/1/allOf/2/properties/descriptor/not", keyword: "not", params: {}, message: "must NOT be valid" };
                            if (vErrors === null) {
                                vErrors = [err10];
                            }
                            else {
    ...
    if (!valid0) {
        var err11 = { instancePath: instancePath, schemaPath: "#/anyOf", keyword: "anyOf", params: {}, message: "must match a schema in anyOf" };
        if (vErrors === null) {
            vErrors = [err11];
        }
        else {
    ...
    if (errors === 0) {
        if (data && typeof data == "object" && !Array.isArray(data)) {
            var missing5 = void 0;
            if ((((data.authorization === undefined) && (missing5 = "authorization")) || ((data.descriptor === undefined) && (missing5 = "descriptor"))) || ((data.recordId === undefined) && (missing5 = "recordId"))) {
                validate16.errors = [{ instancePath: instancePath, schemaPath: "#/required", keyword: "required", params: { missingProperty: missing5 }, message: "must have required property '" + missing5 + "'" }];
                return false;
            }
            else {
                var _errs20 = errors;
                    ...
                    if (valid8) {
                        ...
                        if (valid8) {
                            if (data.attestation !== undefined) {
                                var _errs25 = errors;
                                if (!(validate11(data.attestation, { instancePath: instancePath + "/attestation", parentData: data, parentDataProperty: "attestation", rootData: rootData }))) {
                                    vErrors = vErrors === null ? validate11.errors : vErrors.concat(validate11.errors);
                                    errors = vErrors.length;
                                }
                                        ...
                                        if (errors === _errs27) {
                                            if (data7 && typeof data7 == "object" && !Array.isArray(data7)) {
                                                ...
                                                if ((((data7.algorithm === undefined) && (missing6 = "algorithm")) || ((data7.initializationVector === undefined) && (missing6 = "initializationVector"))) || ((data7.keyEncryption === undefined) && (missing6 = "keyEncryption"))) {
                                                    validate16.errors = [{ instancePath: instancePath + "/encryption", schemaPath: "#/properties/encryption/required", keyword: "required", params: { missingProperty: missing6 }, message: "must have required property '" + missing6 + "'" }];
                                                    return false;
                                                }
                                                else {
                                                    var _errs29 = errors;
                                                    ...
                                                    if (_errs29 === errors) {
                                                        if (data7.algorithm !== undefined) {
                                                            ...
                                                            if (!(data8 === "A256CTR")) {
                                                                validate16.errors = [{ instancePath: instancePath + "/encryption/algorithm", schemaPath: "#/properties/encryption/properties/algorithm/enum", keyword: "enum", params: { allowedValues: schema23.properties.encryption.properties.algorithm.enum }, message: "must be equal to one of the allowed values" }];
                                                                return false;
                                                            }
                                                        ...
                                                        if (valid9) {
                                                            if (data7.initializationVector !== undefined) {
                                                                var data9 = data7.initializationVector;
                                                                var _errs32 = errors;
                                                                var _errs33 = errors;
                                                                if (errors === _errs33) {
                                                            ...
                                                            if (valid9) {
                                                                if (data7.keyEncryption !== undefined) {
                                                                    var data10 = data7.keyEncryption;
                                                                    var _errs35 = errors;
                                                                    if (errors === _errs35) {
                                                                                    ...
                                                                                    if (errors === _errs37) {
                                                                                        if (data11 && typeof data11 == "object" && !Array.isArray(data11)) {
                                                                                            ...
                                                                                            if ((((((((data11.rootKeyId === undefined) && (missing7 = "rootKeyId")) || ((data11.derivationScheme === undefined) && (missing7 = "derivationScheme"))) || ((data11.algorithm === undefined) && (missing7 = "algorithm"))) || ((data11.encryptedKey === undefined) && (missing7 = "encryptedKey"))) || ((data11.initializationVector === undefined) && (missing7 = "initializationVector"))) || ((data11.ephemeralPublicKey === undefined) && (missing7 = "ephemeralPublicKey"))) || ((data11.messageAuthenticationCode === undefined) && (missing7 = "messageAuthenticationCode"))) {
                                                                                                validate16.errors = [{ instancePath: instancePath + "/encryption/keyEncryption/" + i0, schemaPath: "#/properties/encryption/properties/keyEncryption/items/required", keyword: "required", params: { missingProperty: missing7 }, message: "must have required property '" + missing7 + "'" }];
                                                                                                return false;
                                                                                            }
                                                                                            else {
                                                                                                var _errs39 = errors;
                                                                                                for (var key2 in data11) {
                                                                                                    if (!(((((((key2 === "rootKeyId") || (key2 === "derivationScheme")) || (key2 === "algorithm")) || (key2 === "encryptedKey")) || (key2 === "initializationVector")) || (key2 === "ephemeralPublicKey")) || (key2 === "messageAuthenticationCode"))) {
                                                                                                ...
                                                                                                if (_errs39 === errors) {
                                                                                                    if (data11.rootKeyId !== undefined) {
                                                                                                        ...
                                                                                                        if (typeof data11.rootKeyId !== "string") {
                                                                                                            validate16.errors = [{ instancePath: instancePath + "/encryption/keyEncryption/" + i0 + "/rootKeyId", schemaPath: "#/properties/encryption/properties/keyEncryption/items/properties/rootKeyId/type", keyword: "type", params: { type: "string" }, message: "must be string" }];
                                                                                                            return false;
                                                                                                        }
                                                                                                    ...
                                                                                                    if (valid12) {
                                                                                                        if (data11.derivationScheme !== undefined) {
                                                                                                            var data13 = data11.derivationScheme;
                                                                                                            var _errs42 = errors;
                                                                                                        ...
                                                                                                        if (valid12) {
                                                                                                            ...
                                                                                                            if (valid12) {
                                                                                                                if (data11.encryptedKey !== undefined) {
                                                                                                                    var data15 = data11.encryptedKey;
                                                                                                                    var _errs46 = errors;
                                                                                                                    var _errs47 = errors;
                                                                                                                    if (errors === _errs47) {
                                                                                                                        if (typeof data15 === "string") {
                                                                                                                ...
                                                                                                                if (valid12) {
                                                                                                                    if (data11.initializationVector !== undefined) {
                                                                                                                        var data16 = data11.initializationVector;
                                                                                                                        var _errs49 = errors;
                                                                                                                        var _errs50 = errors;
                                                                                                                        if (errors === _errs50) {
                                                                                                                            if (typeof data16 === "string") {
                                                                                                                    ...
                                                                                                                    if (valid12) {
                                                                                                                        if (data11.ephemeralPublicKey !== undefined) {
                                                                                                                            var _errs52 = errors;
                                                                                                                            if (!(validate19(data11.ephemeralPublicKey, { instancePath: instancePath + "/encryption/keyEncryption/" + i0 + "/ephemeralPublicKey", parentData: data11, parentDataProperty: "ephemeralPublicKey", rootData: rootData }))) {
                                                                                                                        ...
                                                                                                                        if (valid12) {
                                                                                                                            if (data11.messageAuthenticationCode !== undefined) {
                                                                                                                                var data18 = data11.messageAuthenticationCode;
                                                                                                                                var _errs53 = errors;
                                                                                                                                var _errs54 = errors;
                                                                                                                                if (errors === _errs54) {
                                    ...
                                    if (valid8) {
                                        if (data.descriptor !== undefined) {
                                            ...
                                            if (data19 && typeof data19 == "object" && !Array.isArray(data19)) {
                                                var missing8 = void 0;
                                                if (((data19.published === undefined) && (missing8 = "published")) || ((data19.datePublished === undefined) && (missing8 = "datePublished"))) {
                                                    var err12 = { instancePath: instancePath + "/descriptor", schemaPath: "#/properties/descriptor/allOf/0/anyOf/0/required", keyword: "required", params: { missingProperty: missing8 }, message: "must have required property '" + missing8 + "'" };
                                                    if (vErrors === null) {
                                                        vErrors = [err12];
                                                    }
                                                    else {
                                                    ...
                                                    if (data19.published !== undefined) {
                                                        var data20 = data19.published;
                                                        if (typeof data20 !== "boolean") {
                                                            var err13 = { instancePath: instancePath + "/descriptor/published", schemaPath: "#/properties/descriptor/allOf/0/anyOf/0/properties/published/type", keyword: "type", params: { type: "boolean" }, message: "must be boolean" };
                                                            if (vErrors === null) {
                                                                vErrors = [err13];
                                                            }
                                                            else {
                                                        ...
                                                        if (!(data20 === true)) {
                                                            var err14 = { instancePath: instancePath + "/descriptor/published", schemaPath: "#/properties/descriptor/allOf/0/anyOf/0/properties/published/enum", keyword: "enum", params: { allowedValues: schema23.properties.descriptor.allOf[0].anyOf[0].properties.published.enum }, message: "must be equal to one of the allowed values" };
                                                            if (vErrors === null) {
                                                                vErrors = [err14];
                                                            }
                                                            else {
                                            ...
                                            if (!valid17) {
                                                ...
                                                if (data19 && typeof data19 == "object" && !Array.isArray(data19)) {
                                                    var missing9 = void 0;
                                                    if ((data19.datePublished === undefined) && (missing9 = "datePublished")) {
                                                        var err15 = {};
                                                        if (vErrors === null) {
                                                            vErrors = [err15];
                                                        }
                                                ...
                                                if (valid19) {
                                                    var err16 = { instancePath: instancePath + "/descriptor", schemaPath: "#/properties/descriptor/allOf/0/anyOf/1/not", keyword: "not", params: {}, message: "must NOT be valid" };
                                                    if (vErrors === null) {
                                                        vErrors = [err16];
                                                    }
                                                    else {
                                                ...
                                                if (errors === _errs64) {
                                                    if (data19 && typeof data19 == "object" && !Array.isArray(data19)) {
                                                        if (data19.published !== undefined) {
                                                            var data21 = data19.published;
                                                            if (typeof data21 !== "boolean") {
                                                                var err17 = { instancePath: instancePath + "/descriptor/published", schemaPath: "#/properties/descriptor/allOf/0/anyOf/1/properties/published/type", keyword: "type", params: { type: "boolean" }, message: "must be boolean" };
                                                                if (vErrors === null) {
                                                                    vErrors = [err17];
                                                                }
                                                                else {
                                                            ...
                                                            if (!(data21 === false)) {
                                                                var err18 = { instancePath: instancePath + "/descriptor/published", schemaPath: "#/properties/descriptor/allOf/0/anyOf/1/properties/published/enum", keyword: "enum", params: { allowedValues: schema23.properties.descriptor.allOf[0].anyOf[1].properties.published.enum }, message: "must be equal to one of the allowed values" };
                                                                if (vErrors === null) {
                                                                    vErrors = [err18];
                                                                }
                                                                else {
                                                ...
                                                if (!valid17) {
                                                    ...
                                                    if (data19 && typeof data19 == "object" && !Array.isArray(data19)) {
                                                        var missing10 = void 0;
                                                        if ((data19.published === undefined) && (missing10 = "published")) {
                                                            var err19 = {};
                                                            if (vErrors === null) {
                                                                vErrors = [err19];
                                                            }
                                                    ...
                                                    if (valid22) {
                                                        var err20 = { instancePath: instancePath + "/descriptor", schemaPath: "#/properties/descriptor/allOf/0/anyOf/2/allOf/0/not", keyword: "not", params: {}, message: "must NOT be valid" };
                                                        if (vErrors === null) {
                                                            vErrors = [err20];
                                                        }
                                                        else {
                                                    ...
                                                    if (valid21) {
                                                        ...
                                                        if (data19 && typeof data19 == "object" && !Array.isArray(data19)) {
                                                            var missing11 = void 0;
                                                            if ((data19.datePublished === undefined) && (missing11 = "datePublished")) {
                                                                var err21 = {};
                                                                if (vErrors === null) {
                                                                    vErrors = [err21];
                                                                }
                                                        ...
                                                        if (valid23) {
                                                            var err22 = { instancePath: instancePath + "/descriptor", schemaPath: "#/properties/descriptor/allOf/0/anyOf/2/allOf/1/not", keyword: "not", params: {}, message: "must NOT be valid" };
                                                            if (vErrors === null) {
                                                                vErrors = [err22];
                                                            }
                                                            else {
                                            ...
                                            if (!valid17) {
                                                var err23 = { instancePath: instancePath + "/descriptor", schemaPath: "#/properties/descriptor/allOf/0/anyOf", keyword: "anyOf", params: {}, message: "must match a schema in anyOf" };
                                                if (vErrors === null) {
                                                    vErrors = [err23];
                                                }
                                                else {
                                            ...
                                            if (errors === _errs56) {
                                                if (data19 && typeof data19 == "object" && !Array.isArray(data19)) {
                                                    var missing12 = void 0;
                                                    if ((((((((data19.interface === undefined) && (missing12 = "interface")) || ((data19.method === undefined) && (missing12 = "method"))) || ((data19.dataCid === undefined) && (missing12 = "dataCid"))) || ((data19.dataSize === undefined) && (missing12 = "dataSize"))) || ((data19.dateCreated === undefined) && (missing12 = "dateCreated"))) || ((data19.dateModified === undefined) && (missing12 = "dateModified"))) || ((data19.dataFormat === undefined) && (missing12 = "dataFormat"))) {
                                                        validate16.errors = [{ instancePath: instancePath + "/descriptor", schemaPath: "#/properties/descriptor/required", keyword: "required", params: { missingProperty: missing12 }, message: "must have required property '" + missing12 + "'" }];
                                                        return false;
                                                    }
                                                    else {
                                                        var _errs76 = errors;
                                                        for (var key3 in data19) {
                                                            if (!(func2.call(schema23.properties.descriptor.properties, key3))) {
                                                        ...
                                                        if (_errs76 === errors) {
                                                            var missing13 = void 0;
                                                            if (data19.recipient !== undefined && ((data19.protocol === undefined) && (missing13 = "protocol"))) {
                                                                validate16.errors = [{ instancePath: instancePath + "/descriptor", schemaPath: "#/properties/descriptor/dependencies", keyword: "dependencies", params: { property: "recipient",
                                                                            missingProperty: missing13,
                                                                            depsCount: 1,
                                                                            deps: "protocol" }, message: "must have property protocol when property recipient is present" }];
                                                                return false;
                                                            }
                                                            else {
                                                                if (data19.interface !== undefined) {
                                                                    var data22 = data19.interface;
                                                                    var _errs77 = errors;
                                                                    ...
                                                                    if (!(data22 === "Records")) {
                                                                        validate16.errors = [{ instancePath: instancePath + "/descriptor/interface", schemaPath: "#/properties/descriptor/properties/interface/enum", keyword: "enum", params: { allowedValues: schema23.properties.descriptor.properties.interface.enum }, message: "must be equal to one of the allowed values" }];
                                                                        return false;
                                                                    }
                                                                ...
                                                                if (valid25) {
                                                                    if (data19.method !== undefined) {
                                                                        ...
                                                                        if (!(data23 === "Write")) {
                                                                            validate16.errors = [{ instancePath: instancePath + "/descriptor/method", schemaPath: "#/properties/descriptor/properties/method/enum", keyword: "enum", params: { allowedValues: schema23.properties.descriptor.properties.method.enum }, message: "must be equal to one of the allowed values" }];
                                                                            return false;
                                                                        }
                                                                        ...
                                                                        if (valid25) {
                                                                            ...
                                                                            if (valid25) {
                                                                                if (data19.protocolPath !== undefined) {
                                                                                    var data26 = data19.protocolPath;
                                                                                    var _errs86 = errors;
                                                                                    if (errors === _errs86) {
                                                                                        if (typeof data26 === "string") {
                                                                                            if (!pattern13.test(data26)) {
                                                                                                validate16.errors = [{ instancePath: instancePath + "/descriptor/protocolPath", schemaPath: "#/properties/descriptor/properties/protocolPath/pattern", keyword: "pattern", params: { pattern: "^[a-zA-Z]+(/[a-zA-Z]+)*$" }, message: "must match pattern \"" + "^[a-zA-Z]+(/[a-zA-Z]+)*$" + "\"" }];
                                                                                                return false;
                                                                                            }
                                                                                        }
                                                                                        else {
                                                                                            validate16.errors = [{ instancePath: instancePath + "/descriptor/protocolPath", schemaPath: "#/properties/descriptor/properties/protocolPath/type", keyword: "type", params: { type: "string" }, message: "must be string" }];
                                                                                            return false;
                                                                                        }
                                                                                    }
                                                                                            ...
                                                                                            if (valid25) {
                                                                                                ...
                                                                                                if (valid25) {
                                                                                                    if (data19.dateCreated !== undefined) {
                                                                                                        var data31 = data19.dateCreated;
                                                                                                        var _errs96 = errors;
                                                                                                        var _errs97 = errors;
                                                                                                        if (errors === _errs97) {
                                                                                                            if (typeof data31 === "string") {
                                                                                                                if (!pattern3.test(data31)) {
                                                                                                                    validate16.errors = [{ instancePath: instancePath + "/descriptor/dateCreated", schemaPath: "https://identity.foundation/dwn/json-schemas/defs.json#/definitions/date-time/pattern", keyword: "pattern", params: { pattern: "^\\d{4}-[0-1]\\d-[0-3]\\dT(?:[0-2]\\d:[0-5]\\d:[0-5]\\d|23:59:60)\\.\\d{6}Z$" }, message: "must match pattern \"" + "^\\d{4}-[0-1]\\d-[0-3]\\dT(?:[0-2]\\d:[0-5]\\d:[0-5]\\d|23:59:60)\\.\\d{6}Z$" + "\"" }];
                                                                                                                    return false;
                                                                                                                }
                                                                                                            }
                                                                                                            else {
                                                                                                                validate16.errors = [{ instancePath: instancePath + "/descriptor/dateCreated", schemaPath: "https://identity.foundation/dwn/json-schemas/defs.json#/definitions/date-time/type", keyword: "type", params: { type: "string" }, message: "must be string" }];
                                                                                                                return false;
                                                                                                            }
                                                                                                        }
                                                                                                    ...
                                                                                                    if (valid25) {
                                                                                                        if (data19.dateModified !== undefined) {
                                                                                                            var data32 = data19.dateModified;
                                                                                                            var _errs99 = errors;
                                                                                                            var _errs100 = errors;
                                                                                                            if (errors === _errs100) {
                                                                                                                if (typeof data32 === "string") {
                                                                                                                    if (!pattern3.test(data32)) {
                                                                                                                        validate16.errors = [{ instancePath: instancePath + "/descriptor/dateModified", schemaPath: "https://identity.foundation/dwn/json-schemas/defs.json#/definitions/date-time/pattern", keyword: "pattern", params: { pattern: "^\\d{4}-[0-1]\\d-[0-3]\\dT(?:[0-2]\\d:[0-5]\\d:[0-5]\\d|23:59:60)\\.\\d{6}Z$" }, message: "must match pattern \"" + "^\\d{4}-[0-1]\\d-[0-3]\\dT(?:[0-2]\\d:[0-5]\\d:[0-5]\\d|23:59:60)\\.\\d{6}Z$" + "\"" }];
                                                                                                                        return false;
                                                                                                                    }
                                                                                                                }
                                                                                                                else {
                                                                                                                    validate16.errors = [{ instancePath: instancePath + "/descriptor/dateModified", schemaPath: "https://identity.foundation/dwn/json-schemas/defs.json#/definitions/date-time/type", keyword: "type", params: { type: "string" }, message: "must be string" }];
                                                                                                                    return false;
                                                                                                                }
                                                                                                            }
                                                                                                        ...
                                                                                                        if (valid25) {
                                                                                                            ...
                                                                                                            if (valid25) {
                                                                                                                if (data19.datePublished !== undefined) {
                                                                                                                    var data34 = data19.datePublished;
                                                                                                                    var _errs104 = errors;
                                                                                                                    var _errs105 = errors;
                                                                                                                    if (errors === _errs105) {
                                                                                                                        if (typeof data34 === "string") {
                                                                                                                            if (!pattern3.test(data34)) {
                                                                                                                                validate16.errors = [{ instancePath: instancePath + "/descriptor/datePublished", schemaPath: "https://identity.foundation/dwn/json-schemas/defs.json#/definitions/date-time/pattern", keyword: "pattern", params: { pattern: "^\\d{4}-[0-1]\\d-[0-3]\\dT(?:[0-2]\\d:[0-5]\\d:[0-5]\\d|23:59:60)\\.\\d{6}Z$" }, message: "must match pattern \"" + "^\\d{4}-[0-1]\\d-[0-3]\\dT(?:[0-2]\\d:[0-5]\\d:[0-5]\\d|23:59:60)\\.\\d{6}Z$" + "\"" }];
                                                                                                                                return false;
                                                                                                                            }
                                                                                                                        }
                                                                                                                        else {
                                                                                                                            validate16.errors = [{ instancePath: instancePath + "/descriptor/datePublished", schemaPath: "https://identity.foundation/dwn/json-schemas/defs.json#/definitions/date-time/type", keyword: "type", params: { type: "string" }, message: "must be string" }];
                                                                                                                            return false;
                                                                                                                        }
                                                                                                                    }
...
exports.EventsGet = validate21;
var schema34 = { "$schema": "http://json-schema.org/draft-07/schema#", "$id": "https://identity.foundation/dwn/json-schemas/events-get.json", "type": "object", "additionalProperties": false, "required": ["authorization", "descriptor"], "properties": { "authorization": { "$ref": "https://identity.foundation/dwn/json-schemas/general-jws.json" }, "descriptor": { "type": "object", "additionalProperties": false, "required": ["interface", "method"], "properties": { "interface": { "enum": ["Events"], "type": "string" }, "method": { "enum": ["Get"], "type": "string" }, "watermark": { "type": "string" } } } } };
function validate21(data, _a) {
    var _b = _a === void 0 ? {} : _a, _c = _b.instancePath, instancePath = _c === void 0 ? "" : _c, parentData = _b.parentData, parentDataProperty = _b.parentDataProperty, _d = _b.rootData, rootData = _d === void 0 ? data : _d;
    ;
    var vErrors = null;
    var errors = 0;
    if (errors === 0) {
        if (data && typeof data == "object" && !Array.isArray(data)) {
            ...
            if (((data.authorization === undefined) && (missing0 = "authorization")) || ((data.descriptor === undefined) && (missing0 = "descriptor"))) {
                ...
                for (var key0 in data) {
                    if (!((key0 === "authorization") || (key0 === "descriptor"))) {
                        validate21.errors = [{ instancePath: instancePath, schemaPath: "#/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key0 }, message: "must NOT have additional properties" }];
                        return false;
                        break;
                    }
                }
                    ...
                    if (valid0) {
                        if (data.descriptor !== undefined) {
                            ...
                            if (errors === _errs3) {
                                if (data1 && typeof data1 == "object" && !Array.isArray(data1)) {
                                    var missing1 = void 0;
                                    if (((data1.interface === undefined) && (missing1 = "interface")) || ((data1.method === undefined) && (missing1 = "method"))) {
                                        ...
                                        if (_errs5 === errors) {
                                            if (data1.interface !== undefined) {
                                                ...
                                                if (!(data2 === "Events")) {
                                                    validate21.errors = [{ instancePath: instancePath + "/descriptor/interface", schemaPath: "#/properties/descriptor/properties/interface/enum", keyword: "enum", params: { allowedValues: schema34.properties.descriptor.properties.interface.enum }, message: "must be equal to one of the allowed values" }];
                                                    return false;
                                                }
                                                var valid1 = _errs6 === errors;
                                            }
                                            ...
                                            if (valid1) {
                                                if (data1.method !== undefined) {
                                                    ...
                                                    if (!(data3 === "Get")) {
                                                        validate21.errors = [{ instancePath: instancePath + "/descriptor/method", schemaPath: "#/properties/descriptor/properties/method/enum", keyword: "enum", params: { allowedValues: schema34.properties.descriptor.properties.method.enum }, message: "must be equal to one of the allowed values" }];
                                                        return false;
                                                    }
                                                    var valid1 = _errs8 === errors;
                                                }
...
exports.Definitions = validate12;
var schema13 = { "$schema": "http://json-schema.org/draft-07/schema#", "$id": "https://identity.foundation/dwn/json-schemas/defs.json", "type": "object", "definitions": { "base64url": { "type": "string", "pattern": "^[A-Za-z0-9_-]+$" }, "uuid": { "type": "string", "pattern": "^[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$" }, "did": { "type": "string", "pattern": "^did:([a-z0-9]+):((?:(?:[a-zA-Z0-9._-]|(?:%[0-9a-fA-F]{2}))*:)*((?:[a-zA-Z0-9._-]|(?:%[0-9a-fA-F]{2}))+))((;[a-zA-Z0-9_.:%-]+=[a-zA-Z0-9_.:%-]*)*)(/[^#?]*)?([?][^#]*)?(#.*)?$" }, "date-time": { "type": "string", "pattern": "^\\d{4}-[0-1]\\d-[0-3]\\dT(?:[0-2]\\d:[0-5]\\d:[0-5]\\d|23:59:60)\\.\\d{6}Z$" } } };
...
exports.GeneralJwk = validate23;
function validate23(data, _a) {
    var _b = _a === void 0 ? {} : _a, _c = _b.instancePath, instancePath = _c === void 0 ? "" : _c, parentData = _b.parentData, parentDataProperty = _b.parentDataProperty, _d = _b.rootData, rootData = _d === void 0 ? data : _d;
    ;
    var vErrors = null;
    var errors = 0;
    ...
    if (data && typeof data == "object" && !Array.isArray(data)) {
        var missing0 = void 0;
        if (((data.crv === undefined) && (missing0 = "crv")) || ((data.x === undefined) && (missing0 = "x"))) {
            var err0 = { instancePath: instancePath, schemaPath: "#/oneOf/0/required", keyword: "required", params: { missingProperty: missing0 }, message: "must have required property '" + missing0 + "'" };
            if (vErrors === null) {
                vErrors = [err0];
            }
            else {
            ...
            if (data.kty !== undefined) {
                var _errs3 = errors;
                if ("EC" !== data.kty) {
                    var err1 = { instancePath: instancePath + "/kty", schemaPath: "#/oneOf/0/properties/kty/const", keyword: "const", params: { allowedValue: "EC" }, message: "must be equal to constant" };
                    if (vErrors === null) {
                        vErrors = [err1];
                    }
                    else {
            ...
            if (valid1) {
                if (data.crv !== undefined) {
                    var _errs4 = errors;
                    if (typeof data.crv !== "string") {
                        var err2 = { instancePath: instancePath + "/crv", schemaPath: "#/oneOf/0/properties/crv/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                        if (vErrors === null) {
                            vErrors = [err2];
                        }
                        else {
                ...
                if (valid1) {
                    if (data.x !== undefined) {
                        var _errs6 = errors;
                        if (typeof data.x !== "string") {
                            var err3 = { instancePath: instancePath + "/x", schemaPath: "#/oneOf/0/properties/x/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                            if (vErrors === null) {
                                vErrors = [err3];
                            }
                            else {
                    ...
                    if (valid1) {
                        if (data.y !== undefined) {
                            var _errs8 = errors;
                            if (typeof data.y !== "string") {
                                var err4 = { instancePath: instancePath + "/y", schemaPath: "#/oneOf/0/properties/y/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                                if (vErrors === null) {
                                    vErrors = [err4];
                                }
                                else {
                        ...
                        if (valid1) {
                            if (data.d !== undefined) {
                                var _errs10 = errors;
                                if (typeof data.d !== "string") {
                                    var err5 = { instancePath: instancePath + "/d", schemaPath: "#/oneOf/0/properties/d/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                                    if (vErrors === null) {
                                        vErrors = [err5];
                                    }
                                    else {
    ...
    if (data && typeof data == "object" && !Array.isArray(data)) {
        var missing1 = void 0;
        if (((data.crv === undefined) && (missing1 = "crv")) || ((data.x === undefined) && (missing1 = "x"))) {
            var err6 = { instancePath: instancePath, schemaPath: "#/oneOf/1/required", keyword: "required", params: { missingProperty: missing1 }, message: "must have required property '" + missing1 + "'" };
            if (vErrors === null) {
                vErrors = [err6];
            }
            else {
            ...
            if (data.kty !== undefined) {
                var _errs13 = errors;
                if ("OKP" !== data.kty) {
                    var err7 = { instancePath: instancePath + "/kty", schemaPath: "#/oneOf/1/properties/kty/const", keyword: "const", params: { allowedValue: "OKP" }, message: "must be equal to constant" };
                    if (vErrors === null) {
                        vErrors = [err7];
                    }
                    else {
            ...
            if (valid2) {
                if (data.crv !== undefined) {
                    var _errs14 = errors;
                    if (typeof data.crv !== "string") {
                        var err8 = { instancePath: instancePath + "/crv", schemaPath: "#/oneOf/1/properties/crv/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                        if (vErrors === null) {
                            vErrors = [err8];
                        }
                        else {
                ...
                if (valid2) {
                    if (data.x !== undefined) {
                        var _errs16 = errors;
                        if (typeof data.x !== "string") {
                            var err9 = { instancePath: instancePath + "/x", schemaPath: "#/oneOf/1/properties/x/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                            if (vErrors === null) {
                                vErrors = [err9];
                            }
                            else {
                    ...
                    if (valid2) {
                        if (data.d !== undefined) {
                            var _errs18 = errors;
                            if (typeof data.d !== "string") {
                                var err10 = { instancePath: instancePath + "/d", schemaPath: "#/oneOf/1/properties/d/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                                if (vErrors === null) {
                                    vErrors = [err10];
                                }
                                else {
    ...
    if (_valid0 && valid0) {
        ...
        if (data && typeof data == "object" && !Array.isArray(data)) {
            var missing2 = void 0;
            if (((data.n === undefined) && (missing2 = "n")) || ((data.e === undefined) && (missing2 = "e"))) {
                var err11 = { instancePath: instancePath, schemaPath: "#/oneOf/2/required", keyword: "required", params: { missingProperty: missing2 }, message: "must have required property '" + missing2 + "'" };
                if (vErrors === null) {
                    vErrors = [err11];
                }
                else {
                ...
                if (data.kty !== undefined) {
                    var _errs21 = errors;
                    if ("RSA" !== data.kty) {
                        var err12 = { instancePath: instancePath + "/kty", schemaPath: "#/oneOf/2/properties/kty/const", keyword: "const", params: { allowedValue: "RSA" }, message: "must be equal to constant" };
                        if (vErrors === null) {
                            vErrors = [err12];
                        }
                        else {
                ...
                if (valid3) {
                    if (data.n !== undefined) {
                        var _errs22 = errors;
                        if (typeof data.n !== "string") {
                            var err13 = { instancePath: instancePath + "/n", schemaPath: "#/oneOf/2/properties/n/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                            if (vErrors === null) {
                                vErrors = [err13];
                            }
                            else {
                    ...
                    if (valid3) {
                        if (data.e !== undefined) {
                            var _errs24 = errors;
                            if (typeof data.e !== "string") {
                                var err14 = { instancePath: instancePath + "/e", schemaPath: "#/oneOf/2/properties/e/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                                if (vErrors === null) {
                                    vErrors = [err14];
                                }
                                else {
                        ...
                        if (valid3) {
                            if (data.d !== undefined) {
                                var _errs26 = errors;
                                if (typeof data.d !== "string") {
                                    var err15 = { instancePath: instancePath + "/d", schemaPath: "#/oneOf/2/properties/d/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                                    if (vErrors === null) {
                                        vErrors = [err15];
                                    }
                                    else {
                            ...
                            if (valid3) {
                                if (data.p !== undefined) {
                                    var _errs28 = errors;
                                    if (typeof data.p !== "string") {
                                        var err16 = { instancePath: instancePath + "/p", schemaPath: "#/oneOf/2/properties/p/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                                        if (vErrors === null) {
                                            vErrors = [err16];
                                        }
                                        else {
                                ...
                                if (valid3) {
                                    if (data.q !== undefined) {
                                        var _errs30 = errors;
                                        if (typeof data.q !== "string") {
                                            var err17 = { instancePath: instancePath + "/q", schemaPath: "#/oneOf/2/properties/q/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                                            if (vErrors === null) {
                                                vErrors = [err17];
                                            }
                                            else {
                                    ...
                                    if (valid3) {
                                        if (data.dp !== undefined) {
                                            var _errs32 = errors;
                                            if (typeof data.dp !== "string") {
                                                var err18 = { instancePath: instancePath + "/dp", schemaPath: "#/oneOf/2/properties/dp/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                                                if (vErrors === null) {
                                                    vErrors = [err18];
                                                }
                                                else {
                                        ...
                                        if (valid3) {
                                            if (data.dq !== undefined) {
                                                var _errs34 = errors;
                                                if (typeof data.dq !== "string") {
                                                    var err19 = { instancePath: instancePath + "/dq", schemaPath: "#/oneOf/2/properties/dq/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                                                    if (vErrors === null) {
                                                        vErrors = [err19];
                                                    }
                                                    else {
                                            ...
                                            if (valid3) {
                                                if (data.qi !== undefined) {
                                                    var _errs36 = errors;
                                                    if (typeof data.qi !== "string") {
                                                        var err20 = { instancePath: instancePath + "/qi", schemaPath: "#/oneOf/2/properties/qi/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                                                        if (vErrors === null) {
                                                            vErrors = [err20];
                                                        }
                                                        else {
                                                ...
                                                if (valid3) {
                                                    if (data.oth !== undefined) {
                                                        ...
                                                        var _errs38 = errors;
                                                        if (!(data18 && typeof data18 == "object" && !Array.isArray(data18))) {
                                                            var err21 = { instancePath: instancePath + "/oth", schemaPath: "#/oneOf/2/properties/oth/type", keyword: "type", params: { type: "object" }, message: "must be object" };
                                                            if (vErrors === null) {
                                                                vErrors = [err21];
                                                            }
                                                            else {
        ...
        if (_valid0 && valid0) {
            ...
            if (data && typeof data == "object" && !Array.isArray(data)) {
                var missing3 = void 0;
                if ((data.k === undefined) && (missing3 = "k")) {
                    var err22 = { instancePath: instancePath, schemaPath: "#/oneOf/3/required", keyword: "required", params: { missingProperty: missing3 }, message: "must have required property '" + missing3 + "'" };
                    if (vErrors === null) {
                        vErrors = [err22];
                    }
                    else {
                    ...
                    if (data.kty !== undefined) {
                        var _errs41 = errors;
                        if ("oct" !== data.kty) {
                            var err23 = { instancePath: instancePath + "/kty", schemaPath: "#/oneOf/3/properties/kty/const", keyword: "const", params: { allowedValue: "oct" }, message: "must be equal to constant" };
                            if (vErrors === null) {
                                vErrors = [err23];
                            }
                            else {
                    ...
                    if (valid4) {
                        if (data.k !== undefined) {
                            var _errs42 = errors;
                            if (typeof data.k !== "string") {
                                var err24 = { instancePath: instancePath + "/k", schemaPath: "#/oneOf/3/properties/k/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                                if (vErrors === null) {
                                    vErrors = [err24];
                                }
                                else {
    ...
    if (!valid0) {
        var err25 = { instancePath: instancePath, schemaPath: "#/oneOf", keyword: "oneOf", params: { passingSchemas: passing0 }, message: "must match exactly one schema in oneOf" };
        if (vErrors === null) {
            vErrors = [err25];
        }
        else {
    ...
    if (errors === 0) {
        if (data && typeof data == "object" && !Array.isArray(data)) {
            var missing4 = void 0;
            if ((data.kty === undefined) && (missing4 = "kty")) {
                validate23.errors = [{ instancePath: instancePath, schemaPath: "#/required", keyword: "required", params: { missingProperty: missing4 }, message: "must have required property '" + missing4 + "'" }];
                return false;
            }
            else {
                if (data.alg !== undefined) {
                ...
                if (valid5) {
                    ...
                    if (valid5) {
                        if (data.kty !== undefined) {
                            ...
                            var _errs48 = errors;
                            if (!((((data23 === "EC") || (data23 === "RSA")) || (data23 === "oct")) || (data23 === "OKP"))) {
                                validate23.errors = [{ instancePath: instancePath + "/kty", schemaPath: "#/properties/kty/enum", keyword: "enum", params: { allowedValues: schema28.properties.kty.enum }, message: "must be equal to one of the allowed values" }];
                                return false;
                            }
...
exports.GeneralJws = validate11;
exports.HooksWrite = validate24;
var schema36 = { "$schema": "http://json-schema.org/draft-07/schema#", "$id": "https://identity.foundation/dwn/json-schemas/hooks-write.json", "type": "object", "additionalProperties": false, "required": ["authorization", "descriptor"], "properties": { "authorization": { "$ref": "https://identity.foundation/dwn/json-schemas/general-jws.json" }, "descriptor": { "type": "object", "additionalProperties": false, "required": ["interface", "method", "dateCreated", "uri", "filter"], "properties": { "interface": { "enum": ["Hooks"], "type": "string" }, "method": { "enum": ["Write"], "type": "string" }, "dateCreated": { "$ref": "https://identity.foundation/dwn/json-schemas/defs.json#/definitions/date-time" }, "schema": { "type": "string" }, "filter": { "type": "object", "minProperties": 1, "additionalProperties": false, "properties": { "method": { "type": "string" } } } } } } };
function validate24(data, _a) {
    ...
    if (errors === 0) {
        if (data && typeof data == "object" && !Array.isArray(data)) {
            var missing0 = void 0;
            if (((data.authorization === undefined) && (missing0 = "authorization")) || ((data.descriptor === undefined) && (missing0 = "descriptor"))) {
                validate24.errors = [{ instancePath: instancePath, schemaPath: "#/required", keyword: "required", params: { missingProperty: missing0 }, message: "must have required property '" + missing0 + "'" }];
                return false;
            }
            else {
                var _errs1 = errors;
                for (var key0 in data) {
                    if (!((key0 === "authorization") || (key0 === "descriptor"))) {
                        validate24.errors = [{ instancePath: instancePath, schemaPath: "#/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key0 }, message: "must NOT have additional properties" }];
                        return false;
                        break;
                    }
                }
                    ...
                    if (valid0) {
                        if (data.descriptor !== undefined) {
                            ...
                            if (errors === _errs3) {
                                if (data1 && typeof data1 == "object" && !Array.isArray(data1)) {
                                    var missing1 = void 0;
                                    if ((((((data1.interface === undefined) && (missing1 = "interface")) || ((data1.method === undefined) && (missing1 = "method"))) || ((data1.dateCreated === undefined) && (missing1 = "dateCreated"))) || ((data1.uri === undefined) && (missing1 = "uri"))) || ((data1.filter === undefined) && (missing1 = "filter"))) {
                                        ...
                                        if (_errs5 === errors) {
                                            if (data1.interface !== undefined) {
                                                ...
                                                if (!(data2 === "Hooks")) {
                                                    validate24.errors = [{ instancePath: instancePath + "/descriptor/interface", schemaPath: "#/properties/descriptor/properties/interface/enum", keyword: "enum", params: { allowedValues: schema36.properties.descriptor.properties.interface.enum }, message: "must be equal to one of the allowed values" }];
                                                    return false;
                                                }
                                                var valid1 = _errs6 === errors;
                                            }
                                            ...
                                            if (valid1) {
                                                if (data1.method !== undefined) {
                                                    ...
                                                    if (!(data3 === "Write")) {
                                                        validate24.errors = [{ instancePath: instancePath + "/descriptor/method", schemaPath: "#/properties/descriptor/properties/method/enum", keyword: "enum", params: { allowedValues: schema36.properties.descriptor.properties.method.enum }, message: "must be equal to one of the allowed values" }];
                                                        return false;
                                                    }
                                                    var valid1 = _errs8 === errors;
                                                }
            ...
            validate24.errors = [{ instancePath: instancePath, schemaPath: "#/type", keyword: "type", params: { type: "object" }, message: "must be object" }];
            return false;
        }
    }
...
exports.JwkVerificationMethod = validate26;
var schema38 = { "$id": "https://identity.foundation/dwn/json-schemas/jwk-verification-method.json", "$schema": "http://json-schema.org/draft-07/schema#", "type": "object", "additionalProperties": false, "required": ["id", "type", "controller", "publicKeyJwk"], "properties": { "id": { "type": "string" }, "type": { "const": "JsonWebKey2020" }, "controller": { "$ref": "https://identity.foundation/dwn/json-schemas/defs.json#/definitions/did" }, "publicKeyJwk": { "$ref": "https://identity.foundation/dwn/json-schemas/public-jwk.json" } } };
            ...
            if (((((data.id === undefined) && (missing0 = "id")) || ((data.type === undefined) && (missing0 = "type"))) || ((data.controller === undefined) && (missing0 = "controller"))) || ((data.publicKeyJwk === undefined) && (missing0 = "publicKeyJwk"))) {
                ...
                for (var key0 in data) {
                    if (!((((key0 === "id") || (key0 === "type")) || (key0 === "controller")) || (key0 === "publicKeyJwk"))) {
                        validate26.errors = [{ instancePath: instancePath, schemaPath: "#/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key0 }, message: "must NOT have additional properties" }];
                        return false;
                        break;
                    }
                }
                        ...
                        if (valid0) {
                            ...
                            if (valid0) {
                                if (data.publicKeyJwk !== undefined) {
                                    var _errs8 = errors;
                                    if (!(validate19(data.publicKeyJwk, { instancePath: instancePath + "/publicKeyJwk", parentData: data, parentDataProperty: "publicKeyJwk", rootData: rootData }))) {
                                        vErrors = vErrors === null ? validate19.errors : vErrors.concat(validate19.errors);
                                        errors = vErrors.length;
                                    }
    ...
    if (errors === 0) {
        if (data && typeof data == "object" && !Array.isArray(data)) {
            ...
            if (((data.authorization === undefined) && (missing0 = "authorization")) || ((data.descriptor === undefined) && (missing0 = "descriptor"))) {
                ...
                for (var key0 in data) {
                    if (!((key0 === "authorization") || (key0 === "descriptor"))) {
                        validate28.errors = [{ instancePath: instancePath, schemaPath: "#/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key0 }, message: "must NOT have additional properties" }];
                        return false;
                        break;
                    }
                }
                                    ...
                                    if (((data1.interface === undefined) && (missing1 = "interface")) || ((data1.method === undefined) && (missing1 = "method"))) {
                                        ...
                                        if (_errs5 === errors) {
                                            if (data1.interface !== undefined) {
                                                ...
                                                if (!(data2 === "Messages")) {
                                                    validate28.errors = [{ instancePath: instancePath + "/descriptor/interface", schemaPath: "#/properties/descriptor/properties/interface/enum", keyword: "enum", params: { allowedValues: schema40.properties.descriptor.properties.interface.enum }, message: "must be equal to one of the allowed values" }];
                                                    return false;
                                                }
                                                var valid1 = _errs6 === errors;
                                            }
                                            ...
                                            if (valid1) {
                                                if (data1.method !== undefined) {
                                                    ...
                                                    if (!(data3 === "Get")) {
                                                        validate28.errors = [{ instancePath: instancePath + "/descriptor/method", schemaPath: "#/properties/descriptor/properties/method/enum", keyword: "enum", params: { allowedValues: schema40.properties.descriptor.properties.method.enum }, message: "must be equal to one of the allowed values" }];
                                                        return false;
                                                    }
                                                    var valid1 = _errs8 === errors;
                                                }
...
exports.PermissionsDefinitions = validate30;
var schema41 = { "$schema": "http://json-schema.org/draft-07/schema#", "$id": "https://identity.foundation/dwn/json-schemas/permissions/defs.json", "type": "object", "definitions": { "conditions": { "type": "object", "additionalProperties": false, "properties": { "attestation": { "enum": ["optional", "required"], "type": "string" }, "delegation": { "type": "boolean" }, "encryption": { "enum": ["optional", "required"], "type": "string" }, "publication": { "type": "boolean" }, "sharedAccess": { "type": "boolean" } } }, "grantedTo": { "$ref": "https://identity.foundation/dwn/json-schemas/defs.json#/definitions/did" }, "grantedBy": { "$ref": "https://identity.foundation/dwn/json-schemas/defs.json#/definitions/did" }, "scope": { "properties": { "method": { "type": "string" }, "objectId": { "type": "string" }, "schema": { "type": "string" } }, "type": "object", "additionalProperties": false } } };
                ...
                if (_errs1 === errors) {
                    ...
                    if (valid0) {
                        if (data.delegationChain !== undefined) {
                            var _errs3 = errors;
                            if (!(validate31(data.delegationChain, { instancePath: instancePath + "/delegationChain", parentData: data, parentDataProperty: "delegationChain", rootData: rootData }))) {
                        ...
                        if (valid0) {
                            if (data.descriptor !== undefined) {
                                ...
                                if (errors === _errs4) {
                                    if (data2 && typeof data2 == "object" && !Array.isArray(data2)) {
                                        var missing1 = void 0;
                                        if ((((data2.interface === undefined) && (missing1 = "interface")) || ((data2.method === undefined) && (missing1 = "method"))) || ((data2.dateCreated === undefined) && (missing1 = "dateCreated"))) {
                                            ...
                                            for (var key1 in data2) {
                                                if (!(func2.call(schema42.properties.descriptor.properties, key1))) {
                                            ...
                                            if (_errs6 === errors) {
                                                if (data2.dateCreated !== undefined) {
                                                    var _errs7 = errors;
                                                ...
                                                if (valid1) {
                                                    if (data2.conditions !== undefined) {
                                                        ...
                                                        if (errors === _errs10) {
                                                            if (data4 && typeof data4 == "object" && !Array.isArray(data4)) {
                                                                ...
                                                                if (_errs12 === errors) {
                                                                    if (data4.attestation !== undefined) {
                                                                        var data5 = data4.attestation;
                                                                        var _errs13 = errors;
                                                                    ...
                                                                    if (valid3) {
                                                                        ...
                                                                        if (valid3) {
                                                                            if (data4.encryption !== undefined) {
                                                                                var data7 = data4.encryption;
                                                                                var _errs17 = errors;
                                                                                if (typeof data7 !== "string") {
                                                                            ...
                                                                            if (valid3) {
                                                                                if (data4.publication !== undefined) {
                                                                                    var _errs19 = errors;
                                                                                ...
                                                                                if (valid3) {
                                                                                    if (data4.sharedAccess !== undefined) {
                                                                                        var _errs21 = errors;
                                                    ...
                                                    if (valid1) {
                                                        if (data2.delegatedFrom !== undefined) {
                                                            var _errs23 = errors;
                                                                    ...
                                                                    if (valid1) {
                                                                        if (data2.interface !== undefined) {
                                                                            ...
                                                                            if (!(data14 === "Permissions")) {
                                                                                validate31.errors = [{ instancePath: instancePath + "/descriptor/interface", schemaPath: "#/properties/descriptor/properties/interface/enum", keyword: "enum", params: { allowedValues: schema42.properties.descriptor.properties.interface.enum }, message: "must be equal to one of the allowed values" }];
                                                                                return false;
                                                                            }
                                                                        ...
                                                                        if (valid1) {
                                                                            if (data2.method !== undefined) {
                                                                                ...
                                                                                if (!(data15 === "Grant")) {
                                                                                    validate31.errors = [{ instancePath: instancePath + "/descriptor/method", schemaPath: "#/properties/descriptor/properties/method/enum", keyword: "enum", params: { allowedValues: schema42.properties.descriptor.properties.method.enum }, message: "must be equal to one of the allowed values" }];
                                                                                    return false;
                                                                                }
                                                                            ...
                                                                            if (valid1) {
                                                                                ...
                                                                                if (valid1) {
                                                                                    if (data2.objectId !== undefined) {
                                                                                        var data20 = data2.objectId;
                                                                                        var _errs47 = errors;
                                                                                        var _errs48 = errors;
                                                                                        if (errors === _errs48) {
                                                                                            if (typeof data20 === "string") {
                                                                                                if (!pattern21.test(data20)) {
...
function validate33(data, _a) {
    ...
    if (errors === 0) {
        if (data && typeof data == "object" && !Array.isArray(data)) {
            var missing0 = void 0;
            if (((data.authorization === undefined) && (missing0 = "authorization")) || ((data.descriptor === undefined) && (missing0 = "descriptor"))) {
                validate33.errors = [{ instancePath: instancePath, schemaPath: "#/required", keyword: "required", params: { missingProperty: missing0 }, message: "must have required property '" + missing0 + "'" }];
                return false;
            }
            else {
                var _errs1 = errors;
                for (var key0 in data) {
                    if (!((key0 === "authorization") || (key0 === "descriptor"))) {
                        validate33.errors = [{ instancePath: instancePath, schemaPath: "#/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key0 }, message: "must NOT have additional properties" }];
                        return false;
                        break;
                    }
                }
                    ...
                    if (valid0) {
                        if (data.descriptor !== undefined) {
                            ...
                            if (errors === _errs3) {
                                if (data1 && typeof data1 == "object" && !Array.isArray(data1)) {
                                    var missing1 = void 0;
                                    if ((((data1.interface === undefined) && (missing1 = "interface")) || ((data1.method === undefined) && (missing1 = "method"))) || ((data1.dateCreated === undefined) && (missing1 = "dateCreated"))) {
                                        ...
                                        var _errs5 = errors;
                                        for (var key1 in data1) {
                                            if (!(func2.call(schema48.properties.descriptor.properties, key1))) {
                                                ...
                                                if (data1.conditions !== undefined) {
                                                    ...
                                                    if (errors === _errs9) {
                                                        if (data3 && typeof data3 == "object" && !Array.isArray(data3)) {
                                                            ...
                                                            if (_errs11 === errors) {
                                                                if (data3.attestation !== undefined) {
                                                                    var data4 = data3.attestation;
                                                                    var _errs12 = errors;
                                                                    if (typeof data4 !== "string") {
                                                                ...
                                                                if (valid3) {
                                                                    ...
                                                                    if (valid3) {
                                                                        if (data3.encryption !== undefined) {
                                                                            var data6 = data3.encryption;
                                                                            var _errs16 = errors;
                                                                        ...
                                                                        if (valid3) {
                                                                            ...
                                                                            if (valid3) {
                                                                                if (data3.sharedAccess !== undefined) {
                                                                                    var _errs20 = errors;
                                                            ...
                                                            if (valid1) {
                                                                if (data1.interface !== undefined) {
                                                                    ...
                                                                    if (!(data12 === "Permissions")) {
                                                                        validate33.errors = [{ instancePath: instancePath + "/descriptor/interface", schemaPath: "#/properties/descriptor/properties/interface/enum", keyword: "enum", params: { allowedValues: schema48.properties.descriptor.properties.interface.enum }, message: "must be equal to one of the allowed values" }];
                                                                        return false;
                                                                    }
                                                                    var valid1 = _errs30 === errors;
                                                                }
                                                                ...
                                                                if (valid1) {
                                                                    if (data1.method !== undefined) {
                                                                        ...
                                                                        if (!(data13 === "Request")) {
                                                                            validate33.errors = [{ instancePath: instancePath + "/descriptor/method", schemaPath: "#/properties/descriptor/properties/method/enum", keyword: "enum", params: { allowedValues: schema48.properties.descriptor.properties.method.enum }, message: "must be equal to one of the allowed values" }];
                                                                            return false;
                                                                        }
                                                                    ...
                                                                    if (valid1) {
                                                                        ...
                                                                        if (valid1) {
                                                                            if (data1.objectId !== undefined) {
                                                                                var data18 = data1.objectId;
                                                                                var _errs44 = errors;
                                                                                var _errs45 = errors;
                                                                                if (errors === _errs45) {
                                                                                    if (typeof data18 === "string") {
                                                                                        if (!pattern21.test(data18)) {
            ...
            validate33.errors = [{ instancePath: instancePath, schemaPath: "#/type", keyword: "type", params: { type: "object" }, message: "must be object" }];
            return false;
        }
    }
...
exports.ProtocolDefinition = validate35;
var schema54 = { "$id": "https://identity.foundation/dwn/json-schemas/protocol-definition.json", "$schema": "http://json-schema.org/draft-07/schema#", "type": "object", "additionalProperties": false, "required": ["types", "structure"], "properties": { "protocol": { "type": "string" }, "types": { "type": "object", "patternProperties": { ".*": { "type": "object", "additionalProperties": false, "properties": { "schema": { "type": "string" }, "dataFormats": { "type": "array", "minItems": 1, "items": { "type": "string" } } } } } }, "structure": { "type": "object", "patternProperties": { ".*": { "$ref": "https://identity.foundation/dwn/json-schemas/protocol-rule-set.json" } } } } };
var pattern25 = new RegExp(".*", "u");
var schema55 = { "$id": "https://identity.foundation/dwn/json-schemas/protocol-rule-set.json", "$schema": "http://json-schema.org/draft-07/schema#", "type": "object", "additionalProperties": false, "properties": { "$actions": { "type": "array", "minItems": 1, "items": { "type": "object", "anyOf": [{ "required": ["who", "can"], "additionalProperties": false, "properties": { "who": { "type": "string", "enum": ["anyone"] }, "can": { "type": "string", "enum": ["read", "write"] } } }, { "required": ["who", "of", "can"], "additionalProperties": false, "properties": { "who": { "type": "string", "enum": ["author", "recipient"] }, "of": { "type": "string" }, "can": { "type": "string", "enum": ["read", "write"] } } }] } } }, "patternProperties": { "^[^$].*": { "$ref": "https://identity.foundation/dwn/json-schemas/protocol-rule-set.json" } } };
var pattern27 = new RegExp("^[^$].*", "u");
...
function validate36(data, _a) {
    ...
    if (errors === 0) {
        if (data && typeof data == "object" && !Array.isArray(data)) {
            var _errs1 = errors;
            for (var key0 in data) {
                if (!((key0 === "$actions") || (pattern27.test(key0)))) {
                    validate36.errors = [{ instancePath: instancePath, schemaPath: "#/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key0 }, message: "must NOT have additional properties" }];
                    return false;
                    break;
                }
            }
            if (_errs1 === errors) {
                if (data.$actions !== undefined) {
                    var data0 = data.$actions;
                    var _errs2 = errors;
                    if (errors === _errs2) {
                        if (Array.isArray(data0)) {
                            if (data0.length < 1) {
                                validate36.errors = [{ instancePath: instancePath + "/$actions", schemaPath: "#/properties/%24actions/minItems", keyword: "minItems", params: { limit: 1 }, message: "must NOT have fewer than 1 items" }];
                                return false;
                            }
                            else {
                                var valid1 = true;
                                ...
                                for (var i0 = 0; i0 < len0; i0++) {
                                    ...
                                    var _errs4 = errors;
                                    if (!(data1 && typeof data1 == "object" && !Array.isArray(data1))) {
                                        validate36.errors = [{ instancePath: instancePath + "/$actions/" + i0, schemaPath: "#/properties/%24actions/items/type", keyword: "type", params: { type: "object" }, message: "must be object" }];
                                        return false;
                                    }
                                    var _errs6 = errors;
                                    var valid2 = false;
                                    ...
                                    if (data1 && typeof data1 == "object" && !Array.isArray(data1)) {
                                        var missing0 = void 0;
                                        if (((data1.who === undefined) && (missing0 = "who")) || ((data1.can === undefined) && (missing0 = "can"))) {
                                            var err0 = { instancePath: instancePath + "/$actions/" + i0, schemaPath: "#/properties/%24actions/items/anyOf/0/required", keyword: "required", params: { missingProperty: missing0 }, message: "must have required property '" + missing0 + "'" };
                                            if (vErrors === null) {
                                                vErrors = [err0];
                                            }
                                            else {
                                            ...
                                            var _errs8 = errors;
                                            for (var key1 in data1) {
                                                if (!((key1 === "who") || (key1 === "can"))) {
                                                    var err1 = { instancePath: instancePath + "/$actions/" + i0, schemaPath: "#/properties/%24actions/items/anyOf/0/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key1 }, message: "must NOT have additional properties" };
                                                    if (vErrors === null) {
                                                        vErrors = [err1];
                                                    }
                                                    else {
                                            ...
                                            if (_errs8 === errors) {
                                                if (data1.who !== undefined) {
                                                    var data2 = data1.who;
                                                    var _errs9 = errors;
                                                    if (typeof data2 !== "string") {
                                                        var err2 = { instancePath: instancePath + "/$actions/" + i0 + "/who", schemaPath: "#/properties/%24actions/items/anyOf/0/properties/who/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                                                        if (vErrors === null) {
                                                            vErrors = [err2];
                                                        }
                                                        else {
                                                    ...
                                                    if (!(data2 === "anyone")) {
                                                        var err3 = { instancePath: instancePath + "/$actions/" + i0 + "/who", schemaPath: "#/properties/%24actions/items/anyOf/0/properties/who/enum", keyword: "enum", params: { allowedValues: schema55.properties.$actions.items.anyOf[0].properties.who.enum }, message: "must be equal to one of the allowed values" };
                                                        if (vErrors === null) {
                                                            vErrors = [err3];
                                                        }
                                                        else {
                                                ...
                                                if (valid3) {
                                                    if (data1.can !== undefined) {
                                                        var data3 = data1.can;
                                                        var _errs11 = errors;
                                                        if (typeof data3 !== "string") {
                                                            var err4 = { instancePath: instancePath + "/$actions/" + i0 + "/can", schemaPath: "#/properties/%24actions/items/anyOf/0/properties/can/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                                                            if (vErrors === null) {
                                                                vErrors = [err4];
                                                            }
                                                            else {
                                                        ...
                                                        if (!((data3 === "read") || (data3 === "write"))) {
                                                            var err5 = { instancePath: instancePath + "/$actions/" + i0 + "/can", schemaPath: "#/properties/%24actions/items/anyOf/0/properties/can/enum", keyword: "enum", params: { allowedValues: schema55.properties.$actions.items.anyOf[0].properties.can.enum }, message: "must be equal to one of the allowed values" };
                                                            if (vErrors === null) {
                                                                vErrors = [err5];
                                                            }
                                                            else {
                                    ...
                                    if (!valid2) {
                                        ...
                                        if (data1 && typeof data1 == "object" && !Array.isArray(data1)) {
                                            var missing1 = void 0;
                                            if ((((data1.who === undefined) && (missing1 = "who")) || ((data1.of === undefined) && (missing1 = "of"))) || ((data1.can === undefined) && (missing1 = "can"))) {
                                                var err6 = { instancePath: instancePath + "/$actions/" + i0, schemaPath: "#/properties/%24actions/items/anyOf/1/required", keyword: "required", params: { missingProperty: missing1 }, message: "must have required property '" + missing1 + "'" };
                                                if (vErrors === null) {
                                                    vErrors = [err6];
                                                }
                                                else {
                                                ...
                                                for (var key2 in data1) {
                                                    if (!(((key2 === "who") || (key2 === "of")) || (key2 === "can"))) {
                                                        var err7 = { instancePath: instancePath + "/$actions/" + i0, schemaPath: "#/properties/%24actions/items/anyOf/1/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key2 }, message: "must NOT have additional properties" };
                                                        if (vErrors === null) {
                                                            vErrors = [err7];
                                                        }
                                                        else {
                                                ...
                                                if (_errs14 === errors) {
                                                    if (data1.who !== undefined) {
                                                        ...
                                                        var _errs15 = errors;
                                                        if (typeof data4 !== "string") {
                                                            var err8 = { instancePath: instancePath + "/$actions/" + i0 + "/who", schemaPath: "#/properties/%24actions/items/anyOf/1/properties/who/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                                                            if (vErrors === null) {
                                                                vErrors = [err8];
                                                            }
                                                            else {
                                                        ...
                                                        if (!((data4 === "author") || (data4 === "recipient"))) {
                                                            var err9 = { instancePath: instancePath + "/$actions/" + i0 + "/who", schemaPath: "#/properties/%24actions/items/anyOf/1/properties/who/enum", keyword: "enum", params: { allowedValues: schema55.properties.$actions.items.anyOf[1].properties.who.enum }, message: "must be equal to one of the allowed values" };
                                                            if (vErrors === null) {
                                                                vErrors = [err9];
                                                            }
                                                            else {
                                                    ...
                                                    if (valid4) {
                                                        if (data1.of !== undefined) {
                                                            var _errs17 = errors;
                                                            if (typeof data1.of !== "string") {
                                                                var err10 = { instancePath: instancePath + "/$actions/" + i0 + "/of", schemaPath: "#/properties/%24actions/items/anyOf/1/properties/of/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                                                                if (vErrors === null) {
                                                                    vErrors = [err10];
                                                                }
                                                                else {
                                                        ...
                                                        if (valid4) {
                                                            if (data1.can !== undefined) {
                                                                ...
                                                                var _errs19 = errors;
                                                                if (typeof data6 !== "string") {
                                                                    var err11 = { instancePath: instancePath + "/$actions/" + i0 + "/can", schemaPath: "#/properties/%24actions/items/anyOf/1/properties/can/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                                                                    if (vErrors === null) {
                                                                        vErrors = [err11];
                                                                    }
                                                                    else {
                                                                ...
                                                                if (!((data6 === "read") || (data6 === "write"))) {
                                                                    var err12 = { instancePath: instancePath + "/$actions/" + i0 + "/can", schemaPath: "#/properties/%24actions/items/anyOf/1/properties/can/enum", keyword: "enum", params: { allowedValues: schema55.properties.$actions.items.anyOf[1].properties.can.enum }, message: "must be equal to one of the allowed values" };
                                                                    if (vErrors === null) {
                                                                        vErrors = [err12];
                                                                    }
                                                                    else {
                                    ...
                                    if (!valid2) {
                                        var err13 = { instancePath: instancePath + "/$actions/" + i0, schemaPath: "#/properties/%24actions/items/anyOf", keyword: "anyOf", params: {}, message: "must match a schema in anyOf" };
                                        if (vErrors === null) {
                                            vErrors = [err13];
                                        }
                                        else {
                            ...
                            validate36.errors = [{ instancePath: instancePath + "/$actions", schemaPath: "#/properties/%24actions/type", keyword: "type", params: { type: "array" }, message: "must be array" }];
                            return false;
                        }
                    }
                    var valid0 = _errs2 === errors;
                ...
                if (valid0) {
                    ...
                    for (var key3 in data) {
                        if (pattern27.test(key3)) {
                            var _errs21 = errors;
                            if (!(wrapper0.validate(data[key3], { instancePath: instancePath + "/" + key3.replace(/~/g, "~0").replace(/\//g, "~1"), parentData: data, parentDataProperty: key3, rootData: rootData }))) {
...
function validate35(data, _a) {
    ...
    if (errors === 0) {
        if (data && typeof data == "object" && !Array.isArray(data)) {
            var missing0 = void 0;
            if (((data.types === undefined) && (missing0 = "types")) || ((data.structure === undefined) && (missing0 = "structure"))) {
                validate35.errors = [{ instancePath: instancePath, schemaPath: "#/required", keyword: "required", params: { missingProperty: missing0 }, message: "must have required property '" + missing0 + "'" }];
                return false;
            }
            else {
                var _errs1 = errors;
                for (var key0 in data) {
                    if (!(((key0 === "protocol") || (key0 === "types")) || (key0 === "structure"))) {
                        validate35.errors = [{ instancePath: instancePath, schemaPath: "#/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key0 }, message: "must NOT have additional properties" }];
                        return false;
                        break;
                    }
                }
                if (_errs1 === errors) {
                    if (data.protocol !== undefined) {
                        ...
                        if (typeof data.protocol !== "string") {
                            validate35.errors = [{ instancePath: instancePath + "/protocol", schemaPath: "#/properties/protocol/type", keyword: "type", params: { type: "string" }, message: "must be string" }];
                            return false;
                        }
                        var valid0 = _errs2 === errors;
                    }
                    ...
                    if (valid0) {
                        if (data.types !== undefined) {
                            ...
                            if (errors === _errs4) {
                                if (data1 && typeof data1 == "object" && !Array.isArray(data1)) {
                                                ...
                                                if (data2 && typeof data2 == "object" && !Array.isArray(data2)) {
                                                    ...
                                                    for (var key2 in data2) {
                                                        if (!((key2 === "schema") || (key2 === "dataFormats"))) {
                                                            validate35.errors = [{ instancePath: instancePath + "/types/" + key1.replace(/~/g, "~0").replace(/\//g, "~1"), schemaPath: "#/properties/types/patternProperties/.*/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key2 }, message: "must NOT have additional properties" }];
                                                            return false;
                                                            break;
                                                        }
                                                    }
                                                    if (_errs8 === errors) {
                                                        if (data2.schema !== undefined) {
                                                            var _errs9 = errors;
                                                            if (typeof data2.schema !== "string") {
                                                                validate35.errors = [{ instancePath: instancePath + "/types/" + key1.replace(/~/g, "~0").replace(/\//g, "~1") + "/schema", schemaPath: "#/properties/types/patternProperties/.*/properties/schema/type", keyword: "type", params: { type: "string" }, message: "must be string" }];
                                                                return false;
                                                            }
                                                            var valid2 = _errs9 === errors;
                                                        }
                                                        ...
                                                        if (valid2) {
                                                            if (data2.dataFormats !== undefined) {
                                                                var data4 = data2.dataFormats;
                                                                var _errs11 = errors;
                                                                if (errors === _errs11) {
                                                                    if (Array.isArray(data4)) {
                                                                        if (data4.length < 1) {
                                                                            validate35.errors = [{ instancePath: instancePath + "/types/" + key1.replace(/~/g, "~0").replace(/\//g, "~1") + "/dataFormats", schemaPath: "#/properties/types/patternProperties/.*/properties/dataFormats/minItems", keyword: "minItems", params: { limit: 1 }, message: "must NOT have fewer than 1 items" }];
                                                                            return false;
                                                                        }
                                                                        else {
                                                                            var valid3 = true;
                                                                            ...
                                                                            for (var i0 = 0; i0 < len0; i0++) {
                                                                                var _errs13 = errors;
                                                                                if (typeof data4[i0] !== "string") {
                                                                                    validate35.errors = [{ instancePath: instancePath + "/types/" + key1.replace(/~/g, "~0").replace(/\//g, "~1") + "/dataFormats/" + i0, schemaPath: "#/properties/types/patternProperties/.*/properties/dataFormats/items/type", keyword: "type", params: { type: "string" }, message: "must be string" }];
                                                                                    return false;
                                                                                }
                                                                                var valid3 = _errs13 === errors;
                                                                                if (!valid3) {
                                                                        ...
                                                                        validate35.errors = [{ instancePath: instancePath + "/types/" + key1.replace(/~/g, "~0").replace(/\//g, "~1") + "/dataFormats", schemaPath: "#/properties/types/patternProperties/.*/properties/dataFormats/type", keyword: "type", params: { type: "array" }, message: "must be array" }];
                                                                        return false;
                                                                    }
                                                                }
                                                                var valid2 = _errs11 === errors;
                                                    ...
                                                    validate35.errors = [{ instancePath: instancePath + "/types/" + key1.replace(/~/g, "~0").replace(/\//g, "~1"), schemaPath: "#/properties/types/patternProperties/.*/type", keyword: "type", params: { type: "object" }, message: "must be object" }];
                                                    return false;
                                                }
                                            }
                                            var valid1 = _errs6 === errors;
                                    ...
                                    validate35.errors = [{ instancePath: instancePath + "/types", schemaPath: "#/properties/types/type", keyword: "type", params: { type: "object" }, message: "must be object" }];
                                    return false;
                                }
                            }
                            var valid0 = _errs4 === errors;
                        ...
                        if (valid0) {
                            if (data.structure !== undefined) {
                                var data6 = data.structure;
                                var _errs15 = errors;
                                if (errors === _errs15) {
                                    if (data6 && typeof data6 == "object" && !Array.isArray(data6)) {
                                        var valid4 = true;
                                        for (var key3 in data6) {
                                            if (pattern25.test(key3)) {
                                                var _errs17 = errors;
                                                if (!(validate36(data6[key3], { instancePath: instancePath + "/structure/" + key3.replace(/~/g, "~0").replace(/\//g, "~1"), parentData: data6, parentDataProperty: key3, rootData: rootData }))) {
                                        ...
                                        validate35.errors = [{ instancePath: instancePath + "/structure", schemaPath: "#/properties/structure/type", keyword: "type", params: { type: "object" }, message: "must be object" }];
                                        return false;
                                    }
                                }
            ...
            validate35.errors = [{ instancePath: instancePath, schemaPath: "#/type", keyword: "type", params: { type: "object" }, message: "must be object" }];
            return false;
        }
    }
...
exports.ProtocolRuleSet = validate36;
exports.ProtocolsConfigure = validate38;
var schema56 = { "$schema": "http://json-schema.org/draft-07/schema#", "$id": "https://identity.foundation/dwn/json-schemas/protocols-configure.json", "type": "object", "additionalProperties": false, "required": ["authorization", "descriptor"], "properties": { "authorization": { "$ref": "https://identity.foundation/dwn/json-schemas/general-jws.json" }, "descriptor": { "type": "object", "additionalProperties": false, "required": ["interface", "method", "dateCreated", "definition"], "properties": { "interface": { "enum": ["Protocols"], "type": "string" }, "method": { "enum": ["Configure"], "type": "string" }, "dateCreated": { "type": "string" }, "definition": { "$ref": "https://identity.foundation/dwn/json-schemas/protocol-definition.json" } } } } };
function validate38(data, _a) {
    ...
    if (errors === 0) {
        if (data && typeof data == "object" && !Array.isArray(data)) {
            var missing0 = void 0;
            if (((data.authorization === undefined) && (missing0 = "authorization")) || ((data.descriptor === undefined) && (missing0 = "descriptor"))) {
                validate38.errors = [{ instancePath: instancePath, schemaPath: "#/required", keyword: "required", params: { missingProperty: missing0 }, message: "must have required property '" + missing0 + "'" }];
                return false;
            }
            else {
                var _errs1 = errors;
                for (var key0 in data) {
                    if (!((key0 === "authorization") || (key0 === "descriptor"))) {
                        validate38.errors = [{ instancePath: instancePath, schemaPath: "#/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key0 }, message: "must NOT have additional properties" }];
                        return false;
                        break;
                    }
                }
                    ...
                    if (valid0) {
                        if (data.descriptor !== undefined) {
                            ...
                            if (errors === _errs3) {
                                if (data1 && typeof data1 == "object" && !Array.isArray(data1)) {
                                    var missing1 = void 0;
                                    if (((((data1.interface === undefined) && (missing1 = "interface")) || ((data1.method === undefined) && (missing1 = "method"))) || ((data1.dateCreated === undefined) && (missing1 = "dateCreated"))) || ((data1.definition === undefined) && (missing1 = "definition"))) {
                                        ...
                                        var _errs5 = errors;
                                        for (var key1 in data1) {
                                            if (!((((key1 === "interface") || (key1 === "method")) || (key1 === "dateCreated")) || (key1 === "definition"))) {
                                        ...
                                        if (_errs5 === errors) {
                                            if (data1.interface !== undefined) {
                                                ...
                                                if (!(data2 === "Protocols")) {
                                                    validate38.errors = [{ instancePath: instancePath + "/descriptor/interface", schemaPath: "#/properties/descriptor/properties/interface/enum", keyword: "enum", params: { allowedValues: schema56.properties.descriptor.properties.interface.enum }, message: "must be equal to one of the allowed values" }];
                                                    return false;
                                                }
                                                var valid1 = _errs6 === errors;
                                            }
                                            ...
                                            if (valid1) {
                                                if (data1.method !== undefined) {
                                                    ...
                                                    if (!(data3 === "Configure")) {
                                                        validate38.errors = [{ instancePath: instancePath + "/descriptor/method", schemaPath: "#/properties/descriptor/properties/method/enum", keyword: "enum", params: { allowedValues: schema56.properties.descriptor.properties.method.enum }, message: "must be equal to one of the allowed values" }];
                                                        return false;
                                                    }
                                                    var valid1 = _errs8 === errors;
                                                }
                                                ...
                                                if (valid1) {
                                                    ...
                                                    if (valid1) {
                                                        if (data1.definition !== undefined) {
                                                            var _errs12 = errors;
                                                            if (!(validate35(data1.definition, { instancePath: instancePath + "/descriptor/definition", parentData: data1, parentDataProperty: "definition", rootData: rootData }))) {
            ...
            validate38.errors = [{ instancePath: instancePath, schemaPath: "#/type", keyword: "type", params: { type: "object" }, message: "must be object" }];
            return false;
        }
    }
...
function validate41(data, _a) {
    ...
    if (errors === 0) {
        if (data && typeof data == "object" && !Array.isArray(data)) {
            var missing0 = void 0;
            if (((data.authorization === undefined) && (missing0 = "authorization")) || ((data.descriptor === undefined) && (missing0 = "descriptor"))) {
                validate41.errors = [{ instancePath: instancePath, schemaPath: "#/required", keyword: "required", params: { missingProperty: missing0 }, message: "must have required property '" + missing0 + "'" }];
                return false;
            }
            else {
                var _errs1 = errors;
                for (var key0 in data) {
                    if (!((key0 === "authorization") || (key0 === "descriptor"))) {
                        validate41.errors = [{ instancePath: instancePath, schemaPath: "#/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key0 }, message: "must NOT have additional properties" }];
                        return false;
                        break;
                    }
                }
                                    ...
                                    if ((((data1.interface === undefined) && (missing1 = "interface")) || ((data1.method === undefined) && (missing1 = "method"))) || ((data1.dateCreated === undefined) && (missing1 = "dateCreated"))) {
                                        ...
                                        if (_errs5 === errors) {
                                            if (data1.interface !== undefined) {
                                                ...
                                                if (!(data2 === "Protocols")) {
                                                    validate41.errors = [{ instancePath: instancePath + "/descriptor/interface", schemaPath: "#/properties/descriptor/properties/interface/enum", keyword: "enum", params: { allowedValues: schema57.properties.descriptor.properties.interface.enum }, message: "must be equal to one of the allowed values" }];
                                                    return false;
                                                }
                                                var valid1 = _errs6 === errors;
                                            }
                                            ...
                                            if (valid1) {
                                                if (data1.method !== undefined) {
                                                    ...
                                                    if (!(data3 === "Query")) {
                                                        validate41.errors = [{ instancePath: instancePath + "/descriptor/method", schemaPath: "#/properties/descriptor/properties/method/enum", keyword: "enum", params: { allowedValues: schema57.properties.descriptor.properties.method.enum }, message: "must be equal to one of the allowed values" }];
                                                        return false;
                                                    }
                                                    var valid1 = _errs8 === errors;
                                                }
            ...
            validate41.errors = [{ instancePath: instancePath, schemaPath: "#/type", keyword: "type", params: { type: "object" }, message: "must be object" }];
            return false;
        }
    }
...
exports.RecordsRead = validate43;
var schema59 = { "$schema": "http://json-schema.org/draft-07/schema#", "$id": "https://identity.foundation/dwn/json-schemas/records-read.json", "type": "object", "additionalProperties": false, "required": ["descriptor"], "properties": { "authorization": { "$ref": "https://identity.foundation/dwn/json-schemas/general-jws.json" }, "descriptor": { "type": "object", "additionalProperties": false, "required": ["interface", "method", "date", "recordId"], "properties": { "interface": { "enum": ["Records"], "type": "string" }, "method": { "enum": ["Read"], "type": "string" }, "date": { "type": "string" }, "recordId": { "type": "string" } } } } };
    ...
    if (errors === 0) {
        if (data && typeof data == "object" && !Array.isArray(data)) {
            ...
            if ((data.descriptor === undefined) && (missing0 = "descriptor")) {
                validate43.errors = [{ instancePath: instancePath, schemaPath: "#/required", keyword: "required", params: { missingProperty: missing0 }, message: "must have required property '" + missing0 + "'" }];
                return false;
            }
            else {
                var _errs1 = errors;
                for (var key0 in data) {
                    if (!((key0 === "authorization") || (key0 === "descriptor"))) {
                        validate43.errors = [{ instancePath: instancePath, schemaPath: "#/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key0 }, message: "must NOT have additional properties" }];
                        return false;
                        break;
                    }
                }
                    ...
                    if (valid0) {
                        if (data.descriptor !== undefined) {
                            ...
                            if (errors === _errs3) {
                                if (data1 && typeof data1 == "object" && !Array.isArray(data1)) {
                                    var missing1 = void 0;
                                    if (((((data1.interface === undefined) && (missing1 = "interface")) || ((data1.method === undefined) && (missing1 = "method"))) || ((data1.date === undefined) && (missing1 = "date"))) || ((data1.recordId === undefined) && (missing1 = "recordId"))) {
                                        ...
                                        if (_errs5 === errors) {
                                            if (data1.interface !== undefined) {
                                                ...
                                                if (!(data2 === "Records")) {
                                                    validate43.errors = [{ instancePath: instancePath + "/descriptor/interface", schemaPath: "#/properties/descriptor/properties/interface/enum", keyword: "enum", params: { allowedValues: schema59.properties.descriptor.properties.interface.enum }, message: "must be equal to one of the allowed values" }];
                                                    return false;
                                                }
                                                var valid1 = _errs6 === errors;
                                            }
                                            ...
                                            if (valid1) {
                                                if (data1.method !== undefined) {
                                                    ...
                                                    if (!(data3 === "Read")) {
                                                        validate43.errors = [{ instancePath: instancePath + "/descriptor/method", schemaPath: "#/properties/descriptor/properties/method/enum", keyword: "enum", params: { allowedValues: schema59.properties.descriptor.properties.method.enum }, message: "must be equal to one of the allowed values" }];
                                                        return false;
                                                    }
                                                    var valid1 = _errs8 === errors;
                                                }
            ...
            validate43.errors = [{ instancePath: instancePath, schemaPath: "#/type", keyword: "type", params: { type: "object" }, message: "must be object" }];
            return false;
        }
    }
