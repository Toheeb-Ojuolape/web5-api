...
function publicKeyToJwk(publicKeyBytes) {
    var x = encoder_js_1.Encoder.bytesToBase64Url(publicKeyBytes);
    var publicJwk = {
        alg: 'EdDSA',
        kty: 'OKP',
        crv: 'Ed25519',
...
exports.ed25519 = {
    sign: function (content, privateJwk) {
        validateKey(privateJwk);
        var privateKeyBytes = encoder_js_1.Encoder.base64UrlToBytes(privateJwk.d);
        return Ed25519.sign(content, privateKeyBytes);
    },
    verify: function (content, signature, publicJwk) {
        validateKey(publicJwk);
        var publicKeyBytes = encoder_js_1.Encoder.base64UrlToBytes(publicJwk.x);
        return Ed25519.verify(signature, content, publicKeyBytes);
    },
    generateKeyPair: function () { return __awaiter(void 0, void 0, void 0, function () {
        var privateKeyBytes, publicKeyBytes, d, publicJwk, privateJwk;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    privateKeyBytes = Ed25519.utils.randomPrivateKey();
                    return [4 /*yield*/, Ed25519.getPublicKey(privateKeyBytes)];
                case 1:
                    publicKeyBytes = _a.sent();
                    d = encoder_js_1.Encoder.bytesToBase64Url(privateKeyBytes);
                    publicJwk = publicKeyToJwk(publicKeyBytes);
                    privateJwk = __assign(__assign({}, publicJwk), { d: d });
                    return [2 /*return*/, { publicJwk: publicJwk, privateJwk: privateJwk }];
            }
        });
    }); },
    publicKeyToJwk: function (publicKeyBytes) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, publicKeyToJwk(publicKeyBytes)];
        });
    }); }
};
