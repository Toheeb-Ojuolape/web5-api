 ...
 */
var HooksWrite = /** @class */ (function (_super) {
    __extends(HooksWrite, _super);
    function HooksWrite() {
     ...
     */
    HooksWrite.create = function (options) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var descriptor, authorization, message, hooksWrite;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        descriptor = {
                            interface: message_js_1.DwnInterfaceName.Hooks,
                    ...
                    case 1:
                        ...
                        hooksWrite = new HooksWrite(message);
                        return [2 /*return*/, hooksWrite];
                }
            });
        });
    };
