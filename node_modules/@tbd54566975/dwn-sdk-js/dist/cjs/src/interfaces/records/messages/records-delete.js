...
var RecordsDelete = /** @class */ (function (_super) {
    __extends(RecordsDelete, _super);
    function RecordsDelete() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    RecordsDelete.parse = function (message) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        recordsDelete = new RecordsDelete(message);
                        return [2 /*return*/, recordsDelete];
                }
            });
        });
    };
     ...
     */
    RecordsDelete.create = function (options) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var recordId, currentTime, descriptor, authorization, message;
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        descriptor = {
                            ...
                            method: message_js_2.DwnMethodName.Delete,
                            recordId: recordId,
                            dateModified: (_a = options.dateModified) !== null && _a !== void 0 ? _a : currentTime
                        };
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, new RecordsDelete(message)];
                }
            });
        });
    };
    RecordsDelete.prototype.authorize = function (tenant) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: 
                    // TODO: #203 - implement protocol-based authorization for RecordsDelete (https://github.com/TBD54566975/dwn-sdk-js/issues/203)
                    return [4 /*yield*/, (0, auth_js_1.authorize)(tenant, this)];
                    case 1:
                        // TODO: #203 - implement protocol-based authorization for RecordsDelete (https://github.com/TBD54566975/dwn-sdk-js/issues/203)
                        _a.sent();
                        return [2 /*return*/];
...
exports.RecordsDelete = RecordsDelete;
