...
exports.EventsGet = void 0;
var auth_js_1 = require("../../../core/auth.js");
var message_js_1 = require("../../../core/message.js");
var EventsGet = /** @class */ (function (_super) {
    __extends(EventsGet, _super);
    function EventsGet() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    EventsGet.parse = function (message) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [2 /*return*/, new EventsGet(message)];
                }
            });
        });
    };
    EventsGet.create = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        descriptor = {
                            interface: message_js_1.DwnInterfaceName.Events,
                            method: message_js_1.DwnMethodName.Get,
                        };
