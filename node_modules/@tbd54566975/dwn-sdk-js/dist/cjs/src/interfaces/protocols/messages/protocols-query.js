...
var ProtocolsQuery = /** @class */ (function (_super) {
    __extends(ProtocolsQuery, _super);
    function ProtocolsQuery() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    ProtocolsQuery.parse = function (message) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, new ProtocolsQuery(message)];
                }
            });
        });
    };
    ProtocolsQuery.create = function (options) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var descriptor, authorization, message, protocolsQuery;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        descriptor = {
                            interface: message_js_1.DwnInterfaceName.Protocols,
                            method: message_js_1.DwnMethodName.Query,
                    ...
                    case 1:
                        ...
                        protocolsQuery = new ProtocolsQuery(message);
                        return [2 /*return*/, protocolsQuery];
                }
            });
        });
    };
    ProtocolsQuery.normalizeFilter = function (filter) {
        if (filter === undefined) {
            return undefined;
        }
        return __assign(__assign({}, filter), { protocol: (0, url_js_1.normalizeProtocolUrl)(filter.protocol) });
    };
    return ProtocolsQuery;
}(message_js_1.Message));
exports.ProtocolsQuery = ProtocolsQuery;
