...
import type { MessageReply, ProtocolsConfigureDescriptor, ProtocolsConfigureOptions, ProtocolsQueryOptions, RecordsDeleteOptions, RecordsQueryOptions, RecordsReadOptions, RecordsWriteOptions } from '@tbd54566975/dwn-sdk-js';
...
export declare class DwnApi {
    ...
    constructor(web5Agent: Web5Agent, connectedDid: string);
    /**
